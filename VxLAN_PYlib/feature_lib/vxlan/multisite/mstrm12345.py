...
class common_setup(aetest.CommonSetup):
    ...
    def testbed_init(self, testscript, testbed):
        global filename_list,filename,ext_rcv_rate,tgn1_ext1site1_intf1,port_handle_ext1site1,test_vrf_ext,load_from_bootflash,test_l3_vni_scale,traffic_profile,vtep_emulation_msite_spirent,rateFull,rateOrphan,site1_group1,site2_group1,site3_group1,ir_mode,vtep_emulation_spirent,vtep_scale,\
        ...
        filename='ib_mstrm_l2_'+str(vlan_vni_scale)+'_l3_'+str(routing_vlan_scale)+'_mc_'+str(mcast_group_scale)
