...
class common_setup(aetest.CommonSetup):
    ...
    def testbed_init(self, testscript, testbed):
        ...
        global vtep_emulation_spirent,vtep_scale,igp,uut_list,leaf_uut_list,spine_uut_list ,bgw_uut_list,sw_uut_list , l3_uut_list,l3_site_uut_list,\
    ...
    def configureTgn(self, testscript, testbed):
        ...
        global tgen, port_handle_sw1site2,port_handle_sw1site3,port_handle_dci1,\
        ...
        port_handle_bgw1site1 = port_handle[port_handle_bgw1site1]
        ...
        orphan_handle_list2 = [port_handle_sw1site1,port_handle_bgw1site1]
        orphan_handle_list = [port_handle_sw1site1,port_handle_bgw1site2,port_handle_bgw2site2,port_handle_bgw1site3,port_handle_bgw2site3]
...
class TC0007_vxlan_ms_anycbgw_traffic(aetest.Testcase):
    ...
    def vxlan_traffic_test_all(self):
        ...
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
            self.failed(goto=['common_cleanup'])
...
class TC0006b_vxlan_ms_anycbgw_vlan_vni_delete(aetest.Testcase):
    ###    This is description for my testcase two
    #Result For: Remove vlan/vni from Current DF for the vlan, verify other BG becomes DF. 
    ...
    @aetest.test
    def vlanvnidelete(self):
        cfgremove = \
        """
        no vlan 1001
        no interface vlan 1001
        int nve 1
        no member vni 101001
        """
        ...
        for uut in site2_bgw_uut_list:
            if '1001' in uut.execute("sh nve ethernet-segment  | inc 'DF Vlans' "):
                df_uut = uut
            else:
                nondf_uut = uut 
        
        df_uut.configure(cfgremove)
        
        countdown(120)
 

        if not '1001' in nondf_uut.execute("sh nve ethernet-segment  | inc 'DF Vlans' "):
            log.info('vlan 1001 deleted at DF BGW is not added at the second BGW ')
            df_uut.configure(cfgadd) 
            self.failed()
...
class TC0008_vxlan_ms_anycbgw_l2fm_restart(aetest.Testcase): 
...
class TC0009_vxlan_ms_anycbgw_l2rib_restart(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0010_vxlan_ms_anycbgw_nve_restart(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0011_vxlan_ms_anycbgw_vlan_mgr_restart(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0012_vxlan_ms_anycbgw_ethpm_restart(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0013_vxlan_ms_anycbgw_ospf_restart(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0014_vxlan_ms_anycbgw_fabric_link_failover1(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0015_vxlan_ms_anycbgw_fabric_link_failover2(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0016_vxlan_ms_anycbgw_spine1_isolation(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0017_vxlan_ms_anycbgw_spine2_isolation(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0018_vxlan_ms_anycbgw_dci1_router_failover(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0019_vxlan_ms_anycbgw_dci2_router_failover(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0020_vxlan_ms_anycbgw_dci_link_failover1(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0021_vxlan_ms_anycbgw_dci_link_failover2(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0022_vxlan_ms_anycbgw_ospf_shut_noshut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0023_vxlan_ms_anycbgw_bgp_shut_noshut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0024_vxlan_ms_anycbgw_spine1_ospf_shut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0025_vxlan_ms_anycbgw_spine2_ospf_shut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0026_vxlan_ms_anycbgw_spine1_bgp_shut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0027_vxlan_ms_anycbgw_spine2_bgp_shut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0028_vxlan_ms_anycbgw_dci1_bgp_shut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0029_vxlan_ms_anycbgw_dci2_bgp_shut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0030_vxlan_ms_anycbgw_restart_ospf(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0031_vxlan_ms_anycbgw_restart_bgp(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0032_vxlan_ms_anycbgw_restart_pim(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0033_vxlan_ms_anycbgw_restart_igmp(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0034_vxlan_ms_anycbgw_restart_mld(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0035_vxlan_ms_anycbgw_anycast_bgw_remote_bgw_nve_shut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0036_vxlan_ms_anycbgw_remote_bgw_ospf_shut(aetest.Testcase):
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0037_vxlan_ms_anycbgw_remote_bgw_bgp_shut(aetest.Testcase):
    ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not AllTrafficTestMsite(port_handle_sw1site2,port_handle_sw1site3,rate,int(pps),orphan_handle_list2):
...
class TC0038_vxlan_ms_anycbgw_Core_flap(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0039_vxlan_ms_anycbgw_ClearIpRoute(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0040_vxlan_ms_anycbgw_clearIpMoute(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0041_vxlan_ms_anycbgw_clear_ospf_Neigh(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0042_vxlan_ms_anycbgw_Clear_IP_Bgp(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0043_vxlan_ms_anycbgw_Clear_Bgp_l2vpn(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0044_vxlan_ms_anycbgw_Spine_ClearIpRoute(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0045_vxlan_ms_anycbgw_Spine_ClearIpMoute(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0046_vxlan_ms_anycbgw_Spine_Clear_OSPF(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0047_vxlan_ms_anycbgw_Spine_Clear_IP_Bgp(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0048_vxlan_ms_anycbgw_Spine_Clear_Bgp_l2vpn(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0049_vxlan_ms_anycbgw_Clear_MAC(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0050_vxlan_ms_anycbgw_Clear_ARP(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0051_vxlan_ms_anycbgw_Clear_ip_route_vrf_all(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0052_vxlan_ms_anycbgw_bgw_reload(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0053_vxlan_ms_anycbgw_vlan_remove_add(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0054_vxlan_ms_anycbgw_nve_Bounce_bgw_Tahoe(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0055_vxlan_ms_anycbgw_nve_Bounce_bgw_sundown(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0056_vxlan_ms_anycbgw_VLAN_Bounce(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0057_vxlan_ms_anycbgw_nve_loop100_shutnoshut(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0058_vxlan_ms_anycbgw_nve_loop0_shutnoshut(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0059_vxlan_ms_anycbgw_one_vlan_remove_add(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0060_vxlan_ms_anycbgw_L3_Vni_remove_Add(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0061_vxlan_ms_anycbgw_Vn_Segment_remove_Add(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC0062_vxlan_ms_anycbgw_macmove_local_to_site1(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        #pass
    ...
    @aetest.test
    def macmoveremote1remote2(self, testscript, testbed):

        for uut in site1_leaf_uut_list + [site2_sw_uut_list[0]]:
            macmoveOverPo(uut,122,'add',vlan_range)

        for uut in [site2_sw_uut_list[0]]:
            macmoveOverPo(uut,101,'remove',vlan_range)
...
class TC0063_vxlan_ms_anycbgw_macmove_site1_to_local(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        #pass
    ...
    def macmoveremote1remote2(self, testscript, testbed):
        ...
        for uut in site1_leaf_uut_list + [site2_sw_uut_list[0]]:
            macmoveOverPo(uut,122,'remove',vlan_range)

        for uut in [site2_sw_uut_list[0]]:
            macmoveOverPo(uut,101,'add',vlan_range)
...
class TC0064_vxlan_ms_anycbgw_macmove_site3_to_site1(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        #pass
    ...
    def macmoveremote1remote2(self, testscript, testbed):
        ...
        for uut in site1_leaf_uut_list + [site3_sw_uut_list[0]]:
            macmoveOverPo(uut,111,'add',vlan_range)

        for uut in [site3_sw_uut_list[0]]:
            macmoveOverPo(uut,101,'remove',vlan_range)
...
class TC0065_vxlan_ms_anycbgw_macmove_site1_to_site3(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        #pass
    ...
    def macmoveremote1remote2(self, testscript, testbed):
        ...
        for uut in site1_leaf_uut_list + [site3_sw_uut_list[0]]:
            macmoveOverPo(uut,111,'remove',vlan_range)
