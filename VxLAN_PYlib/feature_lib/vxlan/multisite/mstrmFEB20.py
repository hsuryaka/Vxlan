...
site2_group1 = '239.21.21.21'
site3_group1 = '239.31.31.31'
site4_group1 = '239.41.41.41'
group_list = [site1_group1]+[site2_group1]+[site3_group1]+[site4_group1]
...
vtep_scale = 8
test_l3_vlan_scale = 1
test_rate = int(test_l3_vlan_scale)*24000*int(group_scale_per_port)
...
class common_setup(aetest.CommonSetup):
    ...
    def testbed_init(self, testscript, testbed):
        global site4_group1,vtep_emulation_msite_spirent,rateFull,rateOrphan,site1_group1,site2_group1,site3_group1,ir_mode,vtep_emulation_spirent,vtep_scale,\
        ...
        site4_uut_list,site4_leaf_uut_list,site4_spine_uut_list,site4_bgw_uut_list,site4_sw_uut_list,tgn1_bgw1site4_intf1,\
        ...
        site4_uut_list = []; site4_leaf_uut_list =[]; site4_spine_uut_list = [];site4_bgw_uut_list =[] ;site4_sw_uut_list =[]
        ...
        tgn1_bgw1site4_intf1 = testbed.devices['tgn1'].interfaces['tgn1_bgw1site4_intf1'].intf
        ...
        for device in testbed.devices:
            ...
            elif 'site4' in (testbed.devices[device].alias):
                site4_uut_list.append(testbed.devices[device])
                if 'leaf' in (testbed.devices[device].alias):
                    site4_leaf_uut_list.append(testbed.devices[device])
                    leaf_uut_list.append(testbed.devices[device])
                    log.info('site4_leaf_uut_list ----%r',site4_leaf_uut_list)
                elif 'spine' in (testbed.devices[device].alias):
                    site4_spine_uut_list.append(testbed.devices[device])
                    spine_uut_list.append(testbed.devices[device])
                elif 'bgw' in (testbed.devices[device].alias):
                    site4_bgw_uut_list.append(testbed.devices[device])
                    bgw_uut_list.append(testbed.devices[device])
                    log.info('site4_bgw_uut_list ----%r',site4_bgw_uut_list)
                elif 'sw' in (testbed.devices[device].alias):
                    site4_sw_uut_list.append(testbed.devices[device])
                    sw_uut_list.append(testbed.devices[device])
        ...
        #site1_group1 = parameters['site1_group1']
        #site2_group1 = parameters['site2_group1']
        #site3_group1 = parameters['site3_group1']
    ...
    def igp_configure(self):     
        ...
        for uut in leaf_uut_list+site1_bgw_uut_list+site2_bgw_uut_list+site3_bgw_uut_list+spine_uut_list:
    ...
    @aetest.subsection
    def site4_internal_bgp_configure(self):        
        ...
        for uut in site4_bgw_uut_list:
            ...
            loopback1_ip = uut.interfaces['loopback1'].ipv4  
            rid =str(loopback1_ip)[:-3]                        
            bgw_bgp_obj1=IbgpLeafNode(uut,rid,'65004',['Nil'],['Nil'],'Loopback1','ibgp-vxlan')
            bgw_bgp_obj1.bgp_conf() 
 
    @aetest.subsection
    def loop1filter_bgw_peering(self):     
        #filterloop1ibgp(uut):
        pcall(filterloop1ibgp,uut=tuple(site1_bgw_uut_list))      
    ...
    def vxlan_bringup(self):
        ...
        try:
            ...
            site2_bgw_uut_list[0],site4_bgw_uut_list[0],site2_leaf_uut_list[0],\
            ...
            as_num=('65001','65001','65001','65002','65004','65002','65003','65003'))
    ...
    def configureTgn(self, testscript, testbed):
        ...
        port_handle_bgw1site2,orphan_handle_list,port_handle_list,orphan_handle_list_sa,port_handle_bgw1site4,\
        orphan_handle_list_anycast_bgw,tgn1_spine2site1_intf1,port_handle_spine2site1,trm_port_handle_list,\
        site1_group1,site2_group1,site3_group1,test_rate,test_l3_vlan_scale,tgn1_bgw1site4_intf1


        try:
            port_handle = ConnectSpirent(labserver_ip,tgn_ip,[tgn1_dci1_intf1,tgn1_sw1site2_intf1,tgn1_sw1site3_intf1,\
            tgn1_bgw1site1_intf1,tgn1_bgw1site2_intf1,tgn1_bgw1site4_intf1,tgn1_sw1site1_intf1,tgn1_spine2site1_intf1])
        ...
        port_handle_bgw1site4 = port_handle[tgn1_bgw1site4_intf1]
        ...
        port_handle_bgw1site2,port_handle_sw1site1,port_handle_spine2site1,port_handle_bgw1site4]
...
class TC00005_vxlan_dci_bgp_configs(aetest.Testcase):
    ...
    def dciEbgpevpn4Bringup(self):
        ...
        try:
            pcall(multisiteDcibgpEvpntrmall4,uut=tuple(dci_uut_list))
            pcall(multisitebgwbgpEvpn44,uut=tuple(bgw_uut_list)) 
        except:
            log.error('multiSiteEnable ##')
            #self.failed(goto=['common_cleanup']) 
...
class TC00006_vxlan_ms_configs(aetest.Testcase):
    ...
    def multiSiteEnable(self):
        ...
        try:
            ...
            pcall(anycastBgwBgpConfgure,site_bgw_uut_list=tuple(site1_bgw_uut_list))
...
class TC00008_vxlan_ms_trm_configs(aetest.Testcase):
    ...
    def trmenable(self):
        try:
            ...
            pcall(mstrmDciConfigure4,uut=tuple(dci_uut_list)) 
...
class TC00009_vxlan_ms_trm_cli_check(aetest.Testcase):
    ...
    def multiSiteCliCheck(self):
        ...
        log.info(banner("Starting bgw_peer_check"))        
        test1 = bgw_peer_check(site1_bgw_uut_list+[site2_bgw_uut_list[0]]+site3_bgw_uut_list,site4_bgw_uut_list)
        if not test1:
            log.info(banner('bgw_peer_check failed'))
...
class TC00011_vxlan_trm_mcast_traffic_enable(aetest.Testcase):
    ...
    def setup(self):
        ...
        global site1_group1,site2_group1,site3_group1,site4_group1,group_list
        ...
        for i in range(0,group_scale_per_port):
            trmTrafficTestConnfigure(site2_bgw_uut_list[0],port_handle_sw1site1,[port_handle_sw1site2,port_handle_sw1site3,port_handle_bgw1site4],'1000',\
                site1_group1,test_l3_vlan_scale)
            trmTrafficTestConnfigure(site2_bgw_uut_list[0],port_handle_sw1site2,[port_handle_sw1site1,port_handle_sw1site3,port_handle_bgw1site4],'1000',\
                site2_group1,test_l3_vlan_scale)
            trmTrafficTestConnfigure(site2_bgw_uut_list[0],port_handle_sw1site3,[port_handle_sw1site1,port_handle_sw1site2,port_handle_bgw1site4],'1000',\
                site3_group1,test_l3_vlan_scale)
            trmTrafficTestConnfigure(site2_bgw_uut_list[0],port_handle_bgw1site4,[port_handle_sw1site1,port_handle_sw1site2,port_handle_sw1site3],'1000',\
                site3_group1,test_l3_vlan_scale)
            ...
            site4_group1 = str(ip_address(site4_group1)+1)
        ...
        #sth.load_xml (filename = "sample_streamblock.xml")
    ...
    def traffic_test(self, testscript, testbed):
        if not msTrmTrafficTestFullTimed(port001=port_handle_sw1site1,rx_rate001=rateFull,\
            ...
            port004=port_handle_bgw1site4,rx_rate004=rateOrphan):
