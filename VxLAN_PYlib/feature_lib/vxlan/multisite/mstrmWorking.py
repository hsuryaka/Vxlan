...
class common_setup(aetest.CommonSetup):
    ...
    def testbed_init(self, testscript, testbed):
        global rate01,rate02,site1_group1,site2_group1,site3_group1,ir_mode,vtep_emulation_spirent,vtep_scale,\
        ...
        rate01 = int(rate)*2+int(test_rate)
        rate02 = int(rate)*4+int(test_rate)    
    ...
    def configureTgn(self, testscript, testbed):
        ...
        site1_group1,site2_group1,site3_group1,test_rate,test_l3_vlan_scale
...
'''
class TC001_Nve_Simulation_To_Scale(aetest.Testcase):
    ...
    @aetest.test
    def vtepEmulation(self):
        """ testcase clean up """
        #vtep_emulation_spirent = 'yes'
        if 'yes' in vtep_emulation_spirent:        
            log.info("in  vtepEmulation")
            vtepEmulation(site1_spine_uut_list[1],vtep_scale,port_handle_spine2site1)
            time.sleep(60)
...
class TC00007_vxlan_ms_traffic(aetest.Testcase):
    ###    This is description for my testcase two
    ...
    def setup(self):
        ...
        log.info(banner("vxlantrafficSetupfull"))
    ...
    def vxlan_traffic_test_all(self):
        ...
        if not AllTrafficTest(port_handle_sw1site1,port_handle_sw1site2,rate,int(pps),orphan_handle_list):
            #self.failed(goto=['common_cleanup']) 
            self.failed()
...
class TC00010_vxlan_ms_traffic_with_Trm_enabled(aetest.Testcase):
    """Result For: Verify the Multisite Traffic with with
    TRM Configurations"""
...
class TC00011_vxlan_trm_mcast_traffic_enable(aetest.Testcase):
    ...
    def traffic_test(self, testscript, testbed):
        if not msTrmTrafficTestFullTimed(port001=port_handle_sw1site1,rx_rate001=test_rate,\
            port002=port_handle_sw1site2,rx_rate002=test_rate,\
            port003=port_handle_sw1site3,rx_rate003=test_rate):
...
class TC000191_vxlan_ms_trm_Continuos_stop_start_traffic(aetest.Testcase):
    ...
    def mcastStreamStopStart(self, testscript, testbed):
        ...
        sth.traffic_control(port_handle = 'all', action = 'start')
...
class TC00072_vxlan_ms_trm_Clear_ARP_MAC(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC00019_vxlan_ms_trm_ip_remove_add(aetest.Testcase):
    ...
    @aetest.test
    def traffic_test1(self, testscript, testbed):
        if not msTrmTrafficTestFullTimed(port001=port_handle_sw1site1,rx_rate001=test_rate,\
            port002=port_handle_sw1site2,rx_rate002=test_rate,\
            port003=port_handle_sw1site3,rx_rate003=test_rate):
            log.info('msTrmTrafficTest failed')
    ...
    @aetest.test
    def traffic_test2(self, testscript, testbed):
        if not msTrmTrafficTestFullTimed(port001=port_handle_sw1site1,rx_rate001=test_rate,\
            port002=port_handle_sw1site2,rx_rate002=test_rate,\
            port003=port_handle_sw1site3,rx_rate003=test_rate):
            log.info('msTrmTrafficTest failed')
    ...
    @aetest.test
    def traffic_test3(self, testscript, testbed):
        if not msTrmTrafficTestFullTimed(port001=port_handle_sw1site1,rx_rate001=test_rate,\
            port002=port_handle_sw1site2,rx_rate002=test_rate,\
            port003=port_handle_sw1site3,rx_rate003=test_rate):
            log.info('msTrmTrafficTest failed')
...
class TC00019_vxlan_ms_trm_vlan_shutnoshut(aetest.Testcase):
    ###    This is description for my tecase two
...
class TC00075_vxlan_ms_trm_l2fm_restart(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not msTrmTrafficTestFullTimed(port001=port_handle_sw1site1,rx_rate001=test_rate,\
...
class TC00076_vxlan_ms_trm_l2rib_restart(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not msTrmTrafficTestFullTimed(port001=port_handle_sw1site1,rx_rate001=test_rate,\
...
class TC00077_vxlan_ms_trm_nve_restart(aetest.Testcase): 
   ###    This is description for my tecase two
    @aetest.setup
    def setup(self):
        if not msTrmTrafficTestFullTimed(port001=port_handle_sw1site1,rx_rate001=test_rate,\
