...
class VMCTFEXAAFUNC017(aetest.Testcase):
     ...
     def vMctAAFlapVpcPoAccess(self,log,testscript,testbed):
         ...
         #action='shut'
         #if shutUnshutVPCPOlink(log,testscript.parameters['uut1'],testscript.parameters['uut1'].alias,testscript.parameters['configDict'],action):
         ...
         #action='shut'
         #if shutUnshutVPCPOlink(log,testscript.parameters['uut2'],testscript.parameters['uut2'].alias,testscript.parameters['configDict'],action):
         #          log.info('Shutting of PO Access is sucess')
         #else:
         #          log.error('Shutting of PO Access failed')
         #          self.failed()
...
class VMCTFEXAAFUNC018(aetest.Testcase):
     ...
     def vMctAAFlapVpcPoMemAccess(self,log,testscript,testbed):
         ...
         #log.info('Shutting the PO on UUT1')
         #action='shut'
         #if shutUnshutVPCPOMemlink(log,testscript.parameters['uut1'],testscript.parameters['uut1'].alias,testscript.parameters['configDict'],action):
         #          log.info('Shutting of PO Access is sucess')
         #else:
         #          log.error('Shutting of PO Access failed')
         #          self.failed()
         ...
         #log.info('Shutting the PO on UUT2')
         #action='shut'
         #if shutUnshutVPCPOMemlink(log,testscript.parameters['uut2'],testscript.parameters['uut2'].alias,testscript.parameters['configDict'],action):
         #          log.info('Shutting of PO Access is sucess')
         #else:
         #          log.error('Shutting of PO Access failed')
         #          self.failed()
