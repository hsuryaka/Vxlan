...
def main():
    ...
    # if args.n_rel_abs_path == None or args.n_rel_upg_abs_apth == None or args.n_1_rel_abs_path == None:
        ...
        testscript = '/ws/ratrajen-bgl/automation/repo_develop/nexus-test-automation/eor/regression/nxos/test/N39kRegression/test/functional/Vxlan/VxLAN_FT_Regr/VxLAN_PVMAP_V6/VxLAN_PVMAP_IPv6_IR_script.py'
        configurationFile = '/ws/ratrajen-bgl/automation/repo_develop/nexus-test-automation/eor/regression/nxos/test/N39kRegression/test/functional/Vxlan/VxLAN_FT_Regr/VxLAN_PVMAP_V6/VxLAN_PVMAP_IPv6_IR_config.yaml'
