...
class TC_VXLAN_PVMAP_000(aetest.Testcase):
    def CHECK_ISSU_IMPACT(self, testscript):
        ...
        issu_impact_cmd = 'sh install all impact nxos bootflash:'+str(testscript.parameters['abs_target_image'])
    ...
    def CHECK_ISSU_IMPACT(self, testscript):
        ...
        # Execute the ISSU Impact command
        impact_output = sec_vtep.execute(issu_impact_cmd, timeout=1200)
        output_split = list(filter(None, impact_output.split('\n')))
        fail_flag = []
        fail_logs = '\n'
    ...
    def testcase_vpc_issu_secondary(self, testscript, steps):
        ...
        with steps.start('Upgrading Secondary'):            
