...
usg_msg = '''
pyats run job VxLAN_PVMAP_Mcast_Job.py -t VxLAN_PVMAP_TB.yaml --n_rel_abs_path <abs_path_n_rel_img> --n_rel_upg_abs_apth <abs_path_n_rel_upg_img>
Example:
pyats run job VxLAN_PVMAP_Mcast_Job.py -t VxLAN_PVMAP_TB.yaml --n_rel_abs_path  'nxos64-cs.10.2.2.72.F.bin' --n_rel_upg_abs_apth 'nxos64-cs.10.2.2.72.F.bin.upg'
'''
...
parser.add_argument('--n_rel_base_img', help='Base image to current release')
...
def main():
    ...
    # if args.n_rel_abs_path == None or args.n_rel_upg_abs_apth == None or args.n_1_rel_abs_path == None:
        ...
        testscript = '/ws/ratrajen-bgl/automation/repo_develop/nexus-test-automation/eor/regression/nxos/test/N39kRegression/test/functional/Vxlan/VxLAN_FT_Regr/VxLAN_PVMAP_V4/VxLAN_PVMAP_Mcast_script.py'
        configurationFile = '/ws/ratrajen-bgl/automation/repo_develop/nexus-test-automation/eor/regression/nxos/test/N39kRegression/test/functional/Vxlan/VxLAN_FT_Regr/VxLAN_PVMAP_V4/VxLAN_PVMAP_Mcast_config.yaml'
        ...
        jobFileParams = {
            'postTestArgs': {
                ...
                'cores_check': 1,
                'logs_check': 1,
                'exclude_log_check_pattern': 'ERROR_VLANS_SUSPENDED|ERROR_VLANS_REMOVED|PLATFORM|LICMGR|IPQOSMGR-4-QOSMGR_PPF_WARNING|SATCTRL-FEX105-2-SOHMS_DIAG_ERROR|VPC-2-PEER_KEEP_ALIVE_RECV_FAIL|USER-1-SYSTEM_MSG|SATCTRL-FEX101-2-SOHMS_ENV_ERROR|AUTHPRIV-3-SYSTEM_MSG|SATCTRL-FEX101-2-SOHMS_DIAG_ERROR',
            },
            'script_flags': {
