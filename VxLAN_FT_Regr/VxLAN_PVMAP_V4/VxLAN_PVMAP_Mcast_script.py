...
class DEVICE_BRINGUP(aetest.Testcase):
    ...
    def enable_feature_set(self, testscript):
        ...
        if not testscript.parameters['script_flags']['skip_device_config']:
            ...
            testscript.parameters['vpcLeafFeatureList']     = vpcLeafFeatureList    = ['vpc', 'ospf', 'pim', 'bgp', 'interface-vlan', 'vn-segment-vlan-based', 'lacp', 'nv overlay', 'fabric forwarding', 'port-security']
            testscript.parameters['LeafFeatureList']        = LeafFeatureList       = ['ospf', 'bgp', 'pim', 'interface-vlan', 'vn-segment-vlan-based', 'lacp', 'nv overlay', 'fabric forwarding', 'port-security']
    ...
    def configure_SPINE(self, testscript):
        ...
        try:
            testscript.parameters['SPINE'].configure('''
                no interface port-channel''' + str(testscript.parameters['LEAF_1_dict']['SPINE_1_UPLINK_PO']['po_id']) + '''
                interface ''' + str(testscript.parameters['intf_SPINE_to_LEAF_1']) + '''
                  mtu 9216
                  no switchport
                  ip address ''' + str(testscript.parameters['LEAF_1_dict']['SPINE_1_UPLINK_PO']['spine_leaf_po_v4']) + str(testscript.parameters['LEAF_1_dict']['SPINE_1_UPLINK_PO']['spine_leaf_mask_v4']) + '''
                ...
                interface ''' + str(testscript.parameters['intf_SPINE_to_LEAF_2']) + '''
                  mtu 9216
                  no switchport
                  ip address ''' + str(testscript.parameters['LEAF_2_dict']['SPINE_1_UPLINK_PO']['spine_leaf_po_v4']) + str(testscript.parameters['LEAF_1_dict']['SPINE_1_UPLINK_PO']['spine_leaf_mask_v4']) + '''
                  ip ospf network point-to-point
                  ip router ospf ''' + str(testscript.parameters['forwardingSysDict']['OSPF_AS']) + ''' area 0.0.0.0
                  ip pim sparse-mode
                  no shutdown
                interface ''' + str(testscript.parameters['intf_SPINE_to_LEAF_3']) + '''
                  mtu 9216
                  no switchport
                  ip address ''' + str(testscript.parameters['LEAF_3_dict']['SPINE_1_UPLINK_PO']['spine_leaf_po_v4']) + str(testscript.parameters['LEAF_1_dict']['SPINE_1_UPLINK_PO']['spine_leaf_mask_v4']) + '''
                  ip ospf network point-to-point
                  ip router ospf ''' + str(testscript.parameters['forwardingSysDict']['OSPF_AS']) + ''' area 0.0.0.0
                  ip pim sparse-mode
                  no shutdown
    ...
    def configure_LEAF_1_2(self, testscript):
        ...
        try:
            testscript.parameters['LEAF-1'].configure('''
              default interface port-channel''' + str(testscript.parameters['LEAF_1_dict']['SPINE_1_UPLINK_PO']['po_id']) + '''
              interface ''' + str(testscript.parameters['intf_LEAF_1_to_SPINE']) + '''
                mtu 9216
                no switchport
                ip address ''' + str(testscript.parameters['LEAF_1_dict']['SPINE_1_UPLINK_PO']['leaf_spine_po_v4']) + str(testscript.parameters['LEAF_1_dict']['SPINE_1_UPLINK_PO']['leaf_spine_mask_v4']) + '''
                ip ospf network point-to-point
                ip router ospf ''' + str(testscript.parameters['forwardingSysDict']['OSPF_AS']) + ''' area 0.0.0.0
                ip pim sparse-mode
                no shutdown
              ...
              interface ''' + str(testscript.parameters['intf_LEAF_1_to_FAN3172']) + '''
                ...
                no shutdown
              default interface ''' + str(testscript.parameters['intf_LEAF_1_to_LEAF_2_2']) + '''
              ...
              interface ''' + str(testscript.parameters['intf_LEAF_1_1_to_IXIA']) + '''
                switchport
                switchport mode trunk
                switchport trunk allowed vlan ''' + str(testscript.parameters['LEAF_1_dict']['MCAST_VNI_data']['l2_vlan_start']) + '''
              ...
              interface ''' + str(testscript.parameters['intf_LEAF_1_2_to_IXIA']) + '''
                ...
                switchport access vlan ''' + str(testscript.parameters['LEAF_1_dict']['MCAST_VNI_data']['l2_vlan_start']) + '''
                spanning-tree port type edge
                no shutdown
        ...
        try:
            testscript.parameters['LEAF-2'].configure('''
              no interface port-channel''' + str(testscript.parameters['LEAF_2_dict']['SPINE_1_UPLINK_PO']['po_id']) + '''
              interface ''' + str(testscript.parameters['intf_LEAF_2_to_SPINE']) + '''
                mtu 9216
                no switchport
                ip address ''' + str(testscript.parameters['LEAF_2_dict']['SPINE_1_UPLINK_PO']['leaf_spine_po_v4']) + str(testscript.parameters['LEAF_2_dict']['SPINE_1_UPLINK_PO']['leaf_spine_mask_v4']) + '''
                ip ospf network point-to-point
                ip router ospf ''' + str(testscript.parameters['forwardingSysDict']['OSPF_AS']) + ''' area 0.0.0.0
                ip pim sparse-mode
                no shutdown
        ...
        try:
            testscript.parameters['LEAF-3'].configure('''
              ...
              interface ''' + str(testscript.parameters['intf_LEAF_3_to_SPINE']) + '''
                no switchport
                mtu 9216
                ip address ''' + str(testscript.parameters['LEAF_3_dict']['SPINE_1_UPLINK_PO']['leaf_spine_po_v4']) + str(testscript.parameters['LEAF_3_dict']['SPINE_1_UPLINK_PO']['leaf_spine_mask_v4']) + '''
                ip ospf network point-to-point
                ip router ospf ''' + str(testscript.parameters['forwardingSysDict']['OSPF_AS']) + ''' area 0.0.0.0
                ip pim sparse-mode
                no shutdown
              ...
              interface ''' + str(testscript.parameters['intf_LEAF_3_to_IXIA']) + '''
                switchport
                switchport mode trunk
                switchport trunk allowed vlan ''' + str(testscript.parameters['LEAF_3_dict']['MCAST_VNI_data']['l2_vlan_start']) + '''
                spanning-tree port type edge trunk
                no shutdown
          ''')
...
class TC_VXLAN_PVMAP_000(aetest.Testcase):
    @aetest.test
    def testcase_vpc_issu_standalone(self, testscript, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_000_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
    ...
    def testcase_vpc_issu_primary(self, testscript, steps):
        ...
        with steps.start("Doing ISSU and verifying core/errors after ISSU"):
            ...
            # Perform ISSU
            result, output = prim_vtep.reload(reload_command=issu_cmd, prompt_recovery=True, dialog=dialog, timeout=2000, return_output=True)
            output_split = list(filter(None, output.split('\n')))
            fail_flag = []
            fail_logs = '\n'
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_000", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed') 

    @aetest.test
    def testcase_vpc_issu_secondary(self, testscript, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        prim_mac        = str(testscript.parameters['PVMAP_Dict']['prim_vpc_mac'])
        ...
        with steps.start('Upgrading Secondary and verifyig core/errors after ISSU'):            
            result, output = sec_vtep.reload(reload_command=issu_cmd, prompt_recovery=True, dialog=dialog, timeout=2000, return_output=True)
            output_split = list(filter(None, output.split('\n')))
            fail_flag = []
            fail_logs = '\n'
    ...
    def verify_error_cores(self, testscript, testbed, steps):
        ...
        stream1 = ixNetwork.Traffic.TrafficItem.find(Name='Trunk VPC To Standalone')
        stream1.StopStatelessTraffic()
        stream2 = ixNetwork.Traffic.TrafficItem.find(Name='Trunk Orphan To Standalone')
...
class TC_VXLAN_PVMAP_012(aetest.Testcase):
    ...
    def testcase_orphan(self, testscript, steps):
        ...
        vlan            = int(testscript.parameters['LEAF_1_Orphan1_TGEN_dict']['vlan_id'])
        vlan1           = int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id'])
        vni_1           = str(testscript.parameters['LEAF_1_dict']['MCAST_VNI_data']['l2_vni_start'])
        vni_2           = str(testscript.parameters['LEAF_3_dict']['MCAST_VNI_data']['l2_vni_start'])
...
# ===============================================================================================#
# TC-ID: TC_VXLAN_PVMAP_015
# Testcase:
#   PVMAP configuration with fex mode
# ===============================================================================================#

class TC_VXLAN_PVMAP_015(aetest.Testcase):
    @aetest.test
    def testcase_orphan(self, testscript, steps):
        prim_vtep       = testscript.parameters['LEAF-1']
        prim_if         = str(testscript.parameters['PVMAP_Dict']['fex_if'])

        
        with steps.start("Verify PVMAP configuration with FEX port"):    
            output = prim_vtep.configure('''interface {intf}
                                        switchport vlan mapping enable'''.format(intf=prim_if))

            if not re.search('ERROR: (switchport vlan mapping enable) vlan mapping enable can not be configured for hif ports', 
                            output):
                log.info("PVMAP validation with fex port success")
                self.passed("PVMAP validation with fex port success")
            else:
                log.error("PVMAP validation with fex port failed")
                self.failed("PVMAP validation with fex port failed")
...
# ======================================================================================================#
# TC-ID: TC_VXLAN_PVMAP_018
# Testcase:  
#   - Delete and add mcast group
#   - Do config-replace to add cli back
#   - Check mac learning and traffic
# ======================================================================================================#
class TC_VXLAN_PVMAP_018(aetest.Testcase):
    @aetest.test
    def testcase_vpc(self, testscript, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        ...
        prim_mac        = str(testscript.parameters['PVMAP_Dict']['prim_vpc_mac'])
        sa_mac          = str(testscript.parameters['PVMAP_Dict']['sa_mac'])
        mcast_grp_cli   = testscript.parameters['PVMAP_Dict']['mcast_grp_cli']
        p1_handle       = testscript.parameters['vpc_handle']
        p2_handle       = testscript.parameters['sa_handle']
        ixNetwork       = testscript.parameters['ixNetwork']
        ...
        with steps.start("Delete/Add and mcast group cli"):
            try:
                prim_vtep.configure('''no {cli} ; sleep 10 ; {cli}
                                    '''.format(cli=mcast_grp_cli))
                sec_vtep.configure('''no {cli} ; sleep 10 ; {cli}
                                    '''.format(cli=mcast_grp_cli))
            except Exception as error:
                log.debug("Unable to configure - Encountered Exception " + str(error))
                self.errored('Exception occurred while configuring PVMAP', 
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_018", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed') 
    ...
    def testcase_orphan(self, testscript, steps):
        ...
        with steps.start("Delete/Add mcast group cli"):
            try:
                prim_vtep.configure('''no {cli} ; sleep 10 ; {cli}
                                    '''.format(cli=mcast_grp_cli))
                sec_vtep.configure('''no {cli} ; sleep 10 ; {cli}
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_018", testscript, traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed') 
...
class TC_VXLAN_PVMAP_019(aetest.Testcase):
    ...
    def testcase_vpc(self, testscript, steps):
        ...
        log.info("Waiting 60secs for the config removal")
        time.sleep(60)
...
# ======================================================================================================#
# TC-ID: TC_VXLAN_PVMAP_020
# Testcase:  
#   - Delete vni mcast group on nve
#   - Do config-replace to add cli back
#   - Check mac learning and traffic
# ======================================================================================================#
class TC_VXLAN_PVMAP_020(aetest.Testcase):
    @aetest.test
    def testcase_vpc(self, testscript, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        ...
        prim_mac        = str(testscript.parameters['PVMAP_Dict']['prim_vpc_mac'])
        sa_mac          = str(testscript.parameters['PVMAP_Dict']['sa_mac'])
        vlan1_vni   	= str(testscript.parameters['LEAF_1_dict']['MCAST_VNI_data']['l2_vni_start'])
        vlan2_vni   	= str(int(testscript.parameters['LEAF_1_dict']['MCAST_VNI_data']['l2_vni_start'])+1)
        mcast_group   	= str(testscript.parameters['LEAF_1_dict']['MCAST_VNI_data']['l2_mcast_grp_ip'])
        p1_handle       = testscript.parameters['vpc_handle']
        p2_handle       = testscript.parameters['sa_handle']
        ixNetwork       = testscript.parameters['ixNetwork']
        ...
        with steps.start("Delete NVE VNI mcast group"):
            try:
                prim_vtep.configure('''interface nve 1
                                       ...
                                       member vni {id2}
                                       no mcast-group {grp}
                                    '''.format(id1=vlan1_vni, id2=vlan2_vni, grp=mcast_group))
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_020", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed') 
    ...
    def testcase_orphan(self, testscript, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_020", testscript, traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed') 
...
# =====================================================================================================#
# TC-ID: TC_VXLAN_PVMAP_038 - Triggers - clear command
# Testcase:  
#   - clear ip bgp restart
#   - Check mac learning and traffic
# ======================================================================================================#
class TC_VXLAN_PVMAP_038(aetest.Testcase):
    @aetest.test
    def testcase_vpc_clear_ipmroute(self, testscript, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        prim_mac        = str(testscript.parameters['PVMAP_Dict']['prim_vpc_mac'])
        ...
        with steps.start("Clear - ip mroute"):
            try:
                prim_vtep.execute('''clear ip mroute *''')
                sec_vtep.configure('''clear ip mroute *''')
            except Exception as error:
                log.debug("Unable to configure - Encountered Exception " + str(error))
                self.errored('Exception occurred while configuring PVMAP', 
                            goto=['common_cleanup']) 
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_038", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed') 

    @aetest.test
    def testcase_orphan_clear_ipmroute(self, testscript, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        prim_mac        = str(testscript.parameters['PVMAP_Dict']['prim_orphan_mac'])
        ...
        with steps.start("Clear - ip mroute"):
            try:
                prim_vtep.execute('''clear ip mroute *''')
                sec_vtep.execute('''clear ip mroute *''')
                sa_vtep.configure('''clear ip mroute *''')
            except Exception as error:
                log.debug("Unable to configure - Encountered Exception " + str(error))
                self.errored('Exception occurred while configuring PVMAP', 
                            goto=['common_cleanup']) 
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_038", testscript, traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed') 
...
# =====================================================================================================#
# TC-ID: TC_VXLAN_PVMAP_048 - ISSD
# Testcase:  
#   - Downgrade - traffic between orphan and standalone
#   - Check mac learning and traffic
# ======================================================================================================#
class TC_VXLAN_PVMAP_048(aetest.Testcase):
    @aetest.test
    def testcase_issd_standalone(self, testscript, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        prim_mac        = str(testscript.parameters['PVMAP_Dict']['prim_orphan_mac'])
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_048", testscript, traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed') 
    
    @aetest.test
    def testcase_orphan_issd_primary(self, testscript, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        prim_mac        = str(testscript.parameters['PVMAP_Dict']['prim_orphan_mac'])
        ...
        with steps.start("Doing ISSD and verifying core/errors after ISSD"):
            ...
            # Perform ISSU
            result, output = prim_vtep.reload(reload_command=issd_cmd, prompt_recovery=True, dialog=dialog, timeout=2000, return_output=True)
            output_split = list(filter(None, output.split('\n')))
            fail_flag = []
            fail_logs = '\n'
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("TC_VXLAN_PVMAP_048_Orphan", testscript, traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed') 

    @aetest.test
    def testcase_orphan_issd_secondary(self, testscript, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        prim_mac        = str(testscript.parameters['PVMAP_Dict']['prim_orphan_mac'])
        ...
        with steps.start('Downgrading Secondary and verifyig core/errors after ISSU'):            
            result, output = sec_vtep.reload(reload_command=issd_cmd, prompt_recovery=True, dialog=dialog, timeout=2000, return_output=True)
            output_split = list(filter(None, output.split('\n')))
            fail_flag = []
            fail_logs = '\n'
...
class common_cleanup(aetest.CommonCleanup):
    ...
    def unconfigure_vteps(self, testscript, testbed, steps):
        ...
        with steps.start("Remove multicast group"):
            try:
                prim_vtep.configure('ip pim rp-address 1.11.1.1 group-list 224.0.0.0/4')
                sec_vtep.configure('ip pim rp-address 1.11.1.1 group-list 224.0.0.0/4')
                sa_vtep.configure('ip pim rp-address 1.11.1.1 group-list 224.0.0.0/4')
            except Exception as error:
                    log.debug("Unable to configure - Encountered Exception " + str(error))
                    self.failed("Unable to configure - Encountered Exception " + str(error))
