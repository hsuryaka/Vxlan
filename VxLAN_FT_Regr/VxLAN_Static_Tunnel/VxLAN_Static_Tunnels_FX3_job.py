...
def main():
    ...
    testscript = './Vxlan_Static_Tunnels_script.py'
    configurationFile = './VxLAN_Static_tunnels_config.yaml'
    ...
    run(testscript=testscript, uut_list=uut_devices, configurationFile = configurationFile,script_flags = script_flags, uids = Or('common_setup','DEVICE_BRINGUP','VERIFY_NETWORK','IXIA_CONFIGURATION','Vlan_vni_modify','Vlan_vni_remove_add'))
    #run(testscript=testscript, uut_list=uut_devices, configurationFile = configurationFile,script_flags = script_flags, uids = Or('common_setup','DEVICE_BRINGUP','VERIFY_NETWORK','IXIA_CONFIGURATION','remove_tunnel_route','remove_route_to_remote_vtep','Modify_source_tunnel_ip','Tunnel_loopback_flap','Ofm_process_restart','Ping_remote_host','Ping_remote_vtep','Tunnel_Uplink_flap','Vlan_vni_modify'))
