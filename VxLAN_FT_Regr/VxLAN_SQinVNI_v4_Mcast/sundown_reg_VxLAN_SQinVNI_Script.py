...
def Vlan_Mapping(json_input, orig_vlan_id):
    for i in range(len(json_input['TABLE_vlan_xlt']['ROW_vlan_xlt']['orig-vlan-id'])):
        if json_input['TABLE_vlan_xlt']['ROW_vlan_xlt']['orig-vlan-id'][i] == orig_vlan_id:
            return json_input['TABLE_vlan_xlt']['ROW_vlan_xlt']['xlt-vlan-id'][i]
    return 0
...
class CheckPoint_Before_Starting_Script(aetest.Testcase):
    """CheckPoint_Before_Starting_Script Test-Case"""
    ...
    @aetest.test
    def CheckPoint_Before_Starting_Script_on_All_Nodes(self, testscript):
        """ CheckPoint_Before_Starting_Script_on_All_Nodes subsection: CheckPoint Before Starting Script on All Nodes """

        log.info(banner("CheckPoint Before Starting Script on All Nodes"))

        testscript.parameters['SPINE'].execute('''

            delete bootflash:b4_script_run.cfg no-prompt

            checkpoint file bootflash:b4_script_run.cfg
        ...
        testscript.parameters['LEAF-3'].execute('''
        ...
        testscript.parameters['FAN'].execute('''
    ...
    def configure_LEAF_1_2(self, testscript):
        ...
        try:
            testscript.parameters['LEAF-1'].configure('''
              ...
              system dot1q-tunnel transit vlan '''+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+'''
              ...
              interface port-channel ''' + str(testscript.parameters['LEAF_1_dict']['VPC_data']['VPC_ACC_po']) + '''
                ...
                switchport vlan mapping '''+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+''' dot1q-tunnel '''+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+'''
                switchport vlan mapping '''+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+''' dot1q-tunnel '''+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+'''
                switchport trunk allowed vlan '''+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+int(testscript.parameters['forwardingSysDict']['VLAN_PER_VRF_count'])-1)+'''
                no shutdown               
        ...
        try:
            testscript.parameters['LEAF-2'].configure('''
              ...
              system dot1q-tunnel transit vlan '''+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+'''
              ...
              interface port-channel ''' + str(testscript.parameters['LEAF_2_dict']['VPC_data']['VPC_ACC_po']) + '''
                switchport
                switchport mode trunk
                switchport vlan mapping '''+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+''' dot1q-tunnel '''+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+'''
                switchport vlan mapping '''+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+''' dot1q-tunnel '''+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+'''
                switchport trunk allowed vlan '''+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+int(testscript.parameters['forwardingSysDict']['VLAN_PER_VRF_count'])-1)+'''
                no shutdown               
        ...
        try:
            testscript.parameters['LEAF-3'].configure('''
              ...
              interface ''' + str(testscript.parameters['intf_LEAF_3_to_IXIA']) + '''
                switchport
                switchport mode trunk
                switchport vlan mapping '''+str(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+''' dot1q-tunnel '''+str(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+'''
                switchport vlan mapping '''+str(int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_step_1']))+''' dot1q-tunnel '''+str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+1)+'''
                switchport trunk allowed vlan '''+str(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+int(testscript.parameters['forwardingSysDict']['VLAN_PER_VRF_count'])-1)+'''
                no shutdown
    ...
    def configure_FAN(self, testscript):
        ...
        try:
            testscript.parameters['FAN'].configure(
              ...
              vlan '''+str(testscript.parameters['LEAF_12_TGEN_dict']['vlan_id_1'])+''', '''+str(int(testscript.parameters['LEAF_12_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_12_TGEN_dict']['vlan_id_step_1']))+'''
              exit
...
class IXIA_CONFIGURATION_CONFIGURE_SQinVNI_IXIA_TRAFFIC(aetest.Testcase):
    ...
    def CONFIGURE_SQinVNI_IXIA_TRAFFIC(self, testscript):
        ...
        if not testscript.parameters['script_flags']['skip_tgen_config']:
            ...
            if SQinVNI_v4_TI_1 == 0 or SQinVNI_v4_TI_2 == 0 or SQinVNI_v4_TI_3 == 0 or SQinVNI_v4_TI_4 == 0 or SQinVNI_v6_TI_2 == 0 or SQinVNI_v6_TI_4 == 0:
...
class IXIA_CONFIGURATION_CONFIGURE_L2KUC_IXIA_TRAFFIC(aetest.Testcase):
    ...
    def CONFIGURE_L2KUC_IXIA_TRAFFIC(self, testscript):
        ...
        if not testscript.parameters['script_flags']['skip_tgen_config']:
            ...
            if L2KUC_v4_TI_1 == 0 or L2KUC_v4_TI_2 == 0 or L2KUC_v4_TI_3 == 0 or L2KUC_v4_TI_4 == 0 or L2KUC_v6_TI_2 == 0 or L2KUC_v6_TI_4 == 0:
...
class IXIA_CONFIGURATION_CONFIGURE_L3KUC_IXIA_TRAFFIC(aetest.Testcase):
    ...
    def CONFIGURE_L3KUC_IXIA_TRAFFIC(self, testscript):
        ...
        if not testscript.parameters['script_flags']['skip_tgen_config']:
            ...
            if L3KUC_v4_TI_1 == 0 or L3KUC_v4_TI_2 == 0 or L3KUC_v4_TI_3 == 0 or L3KUC_v4_TI_4 == 0 or L3KUC_v6_TI_2 == 0 or L3KUC_v6_TI_4 == 0:
...
class TC001_Platform_plus_SW_Version_Info(aetest.Testcase):
    """ TC001_Platform_plus_SW_Version_Info """

    @aetest.test
    def Platform_plus_SW_Version_Info(self, testscript):
        """ Platform_plus_SW_Version_Info """
...
class TC002_Verify_VLAN_Mapping_on_Access_Interfaces_on_All_Nodes(aetest.Testcase):
    """ TC002_Verify_VLAN_Mapping_on_Access_Interfaces_on_All_Nodes """

    @aetest.test
    def Verify_VLAN_Mapping_on_Access_Interfaces_on_All_Nodes(self, testscript):
        """ Verify_VLAN_Mapping_on_Access_Interfaces_on_All_Nodes """

        fail_flag = 0

        #Verify on LEAF-1
        leaf1_po_json = json.loads(testscript.parameters['LEAF-1'].execute('''show interface port-channel ''' + str(testscript.parameters['LEAF_1_dict']['VPC_data']['VPC_ACC_po']) + ''' vlan mapping | json'''))
        leaf1_po_vlan_mapping_1 = Vlan_Mapping(leaf1_po_json, testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])
        leaf1_po_vlan_mapping_2 = Vlan_Mapping(leaf1_po_json, str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1'])))

        if int(leaf1_po_vlan_mapping_1) == int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1

        if int(leaf1_po_vlan_mapping_2) == int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1

        leaf1_int_json = json.loads(testscript.parameters['LEAF-1'].execute('''show interface ''' + str(testscript.parameters['intf_LEAF_1_to_IXIA']) + ''' vlan mapping | json'''))
        leaf1_int_vlan_mapping_1 = Vlan_Mapping(leaf1_int_json, testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])
        leaf1_int_vlan_mapping_2 = Vlan_Mapping(leaf1_int_json, str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1'])))

        if int(leaf1_int_vlan_mapping_1) == int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1

        if int(leaf1_int_vlan_mapping_2) == int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1
        ...
        #Verify on LEAF-2
        leaf2_po_json = json.loads(testscript.parameters['LEAF-2'].execute('''show interface port-channel ''' + str(testscript.parameters['LEAF_2_dict']['VPC_data']['VPC_ACC_po']) + ''' vlan mapping | json'''))
        leaf2_po_vlan_mapping_1 = Vlan_Mapping(leaf2_po_json, testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])
        leaf2_po_vlan_mapping_2 = Vlan_Mapping(leaf2_po_json, str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1'])))

        if int(leaf2_po_vlan_mapping_1) == int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1

        if int(leaf2_po_vlan_mapping_2) == int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1

        leaf2_int_json = json.loads(testscript.parameters['LEAF-2'].execute('''show interface ''' + str(testscript.parameters['intf_LEAF_2_to_IXIA']) + ''' vlan mapping | json'''))
        leaf2_int_vlan_mapping_1 = Vlan_Mapping(leaf2_int_json, testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])
        leaf2_int_vlan_mapping_2 = Vlan_Mapping(leaf2_int_json, str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1'])))

        if int(leaf2_int_vlan_mapping_1) == int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1

        if int(leaf2_int_vlan_mapping_2) == int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1
        ...
        #Verify on LEAF-3
        leaf3_int_json = json.loads(testscript.parameters['LEAF-3'].execute('''show interface ''' + str(testscript.parameters['intf_LEAF_3_to_IXIA']) + ''' vlan mapping | json'''))
        leaf3_int_vlan_mapping_1 = Vlan_Mapping(leaf3_int_json, testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])
        leaf3_int_vlan_mapping_2 = Vlan_Mapping(leaf3_int_json, str(int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_step_1'])))

        if int(leaf3_int_vlan_mapping_1) == int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1

        if int(leaf3_int_vlan_mapping_2) == int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1

        if fail_flag == 1:
            self.failed(reason="All Customer VLAN's are NOT Mapped to Correct Provider VLAN's on all LEAFs")
        else:
            self.passed(reason="All Customer VLAN's are Mapped to Correct Provider VLAN's on all LEAFs")
...
class TC003_VxLAN_SQinVNI_Verification(aetest.Testcase):
    """ TC003_VxLAN_SQinVNI_Verification """
...
class TC004_VxLAN_SQinVNI_UpLink_Flap(aetest.Testcase):
    """ TC004_VxLAN_SQinVNI_UpLink_Flap """
...
class TC005_VxLAN_SQinVNI_vPC_UpLink_Flap(aetest.Testcase):
    """ TC005_VxLAN_SQinVNI_vPC_UpLink_Flap """
...
class TC006_VxLAN_SQinVNI_Access_Link_Flap(aetest.Testcase):
    """ TC006_VxLAN_SQinVNI_Access_Link_Flap """
...
class TC007_VxLAN_SQinVNI_vPC_Access_LinkFlap(aetest.Testcase):
    """ TC007_VxLAN_SQinVNI_vPC_Access_LinkFlap """
...
class TC008_VxLAN_SQinVNI_NVE_Flap(aetest.Testcase):
    """ TC008_VxLAN_SQinVNI_NVE_Flap """
...
class TC009_VxLAN_SQinVNI_vPC_NVE_Flap(aetest.Testcase):
    """ TC009_VxLAN_SQinVNI_vPC_NVE_Flap """
...
class TC010_VxLAN_SQinVNI_Add_Remove_VN_Segemnt(aetest.Testcase):
    """ TC010_VxLAN_SQinVNI_Add_Remove_VN_Segemnt """
...
class TC011_VxLAN_SQinVNI_vPC_Remove_Add_VN_Segment(aetest.Testcase):
    """ TC011_VxLAN_SQinVNI_vPC_Remove_Add_VN_Segment """
...
class TC012_VxLAN_SQinVNI_SA_Remove_Add_Member_VN(aetest.Testcase):
    """ TC012_VxLAN_SQinVNI_SA_Remove_Add_Member_VN """
...
class TC013_VxLAN_SQinVNI_vPC_Remove_Add_Member_VNI(aetest.Testcase):
    """ TC013_VxLAN_SQinVNI_vPC_Remove_Add_Member_VNI """
...
class TC014_VxLAN_SQinVNI_SA_Loopback_Flap(aetest.Testcase):
    """ TC014_VxLAN_SQinVNI_SA_Loopback_Flap """
...
class TC015_VxLAN_SQinVNI_vPC_Loopback_Flap(aetest.Testcase):
    """ TC015_VxLAN_SQinVNI_vPC_Loopback_Flap """
...
class TC016_VxLAN_SQinVNI_SA_Remove_Add_VLAN(aetest.Testcase):
    """ TC016_VxLAN_SQinVNI_SA_Remove_Add_VLAN """
...
class TC017_VxLAN_SQinVNI_vPC_Remove_Add_VLAN(aetest.Testcase):
    """ TC017_VxLAN_SQinVNI_vPC_Remove_Add_VLAN """
...
class TC018_VxLAN_SQinVNI_Change_Access_VLAN_All_Nodes(aetest.Testcase):
    """ TC018_VxLAN_SQinVNI_Change_Access_VLAN_All_Nodes """
    ...
    def Change_Access_VLAN_All_Nodes(self, testscript):
        ...
        testscript.parameters['LEAF-1'].configure('''
              ...
              interface port-channel ''' + str(testscript.parameters['LEAF_1_dict']['VPC_data']['VPC_ACC_po']) + '''
                no switchport vlan mapping '''+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+''' dot1q-tunnel '''+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+'''
                no switchport vlan mapping '''+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+''' dot1q-tunnel '''+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+'''
                switchport vlan mapping '''+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+''' dot1q-tunnel '''+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+'''
                switchport vlan mapping '''+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+''' dot1q-tunnel '''+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+'''
        ...
        testscript.parameters['LEAF-2'].configure('''
              ...
              interface port-channel ''' + str(testscript.parameters['LEAF_2_dict']['VPC_data']['VPC_ACC_po']) + '''
                no switchport vlan mapping '''+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+''' dot1q-tunnel '''+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+'''
                no switchport vlan mapping '''+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+''' dot1q-tunnel '''+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+'''
                switchport vlan mapping '''+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+''' dot1q-tunnel '''+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+'''
                switchport vlan mapping '''+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+''' dot1q-tunnel '''+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+'''    
        ...
        testscript.parameters['LEAF-3'].configure('''
              ...
              interface ''' + str(testscript.parameters['intf_LEAF_3_to_IXIA']) + '''
                no switchport vlan mapping '''+str(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+''' dot1q-tunnel '''+str(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+'''
                no switchport vlan mapping '''+str(int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_step_1']))+''' dot1q-tunnel '''+str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+1)+'''
                switchport vlan mapping '''+str(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+''' dot1q-tunnel '''+str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+1)+'''
                switchport vlan mapping '''+str(int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_step_1']))+''' dot1q-tunnel '''+str(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+'''
    ...
    def Verify_VLAN_Mapping_on_Access_Interfaces_on_All_Nodes(self, testscript):
        ...
        if int(leaf1_po_vlan_mapping_1) == int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1

        if int(leaf1_po_vlan_mapping_2) == int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1
        ...
        if int(leaf1_int_vlan_mapping_1) == int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1

        if int(leaf1_int_vlan_mapping_2) == int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_1_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1
        ...
        if int(leaf2_po_vlan_mapping_1) == int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1

        if int(leaf2_po_vlan_mapping_2) == int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1
        ...
        if int(leaf2_int_vlan_mapping_1) == int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1

        if int(leaf2_int_vlan_mapping_2) == int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_2_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1
        ...
        if int(leaf3_int_vlan_mapping_1) == int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+1:
            log.info("PASS: CVLAN-"+str(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+" is mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+1)+"")
        else:
            log.debug("FAIL: CVLAN-"+str(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+" is NOT mapping correctly to PVLAN-"+str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+1)+"")
            fail_flag = 1

        if int(leaf3_int_vlan_mapping_2) == int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start']):
            log.info("PASS: CVLAN-"+str(int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_step_1']))+" is mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+"")
        else:
            log.debug("FAIL: CVLAN-"+str(int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_1'])+int(testscript.parameters['LEAF_3_TGEN_dict']['vlan_id_step_1']))+" is NOT mapping correctly to PVLAN-"+str(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vlan_start'])+"")
            fail_flag = 1
    ...
    @aetest.test
    def Revert_Back_Configs(self, testscript):
        """ Revert_Back_Configs """
        
        testscript.parameters['LEAF-1'].configure('''configure replace bootflash:config_replace.cfg verbose''', timeout=300)
        testscript.parameters['LEAF-2'].configure('''configure replace bootflash:config_replace.cfg verbose''', timeout=300)
        testscript.parameters['LEAF-3'].configure('''configure replace bootflash:config_replace.cfg verbose''', timeout=300)
...
class TC019_VxLAN_SQinVNI_ConsistencyCheck(aetest.Testcase):
    """ TC019_VxLAN_SQinVNI_ConsistencyCheck """
    ...
    def VxLAN_CC(self, testscript):
        ...
        VxLANCC = json.loads(testscript.parameters['LEAF-1'].execute('show consistency-checker vxlan config-check brief | no', timeout=300))
        ...
        VxLANCC = testscript.parameters['LEAF-1'].execute('show consistency-checker vxlan selective-qinvni | no', timeout=300)
        ...
        VxLANCC = testscript.parameters['LEAF-2'].execute('show consistency-checker vxlan selective-qinvni | no', timeout=300)
        ...
        VxLANCC = testscript.parameters['LEAF-3'].execute('show consistency-checker vxlan selective-qinvni | no', timeout=300)
        ...
        VxLANCC = testscript.parameters['LEAF-1'].execute('show consistency-checker vxlan selective-qinvni interface port-channel '+str(testscript.parameters['LEAF_1_dict']['VPC_data']['VPC_ACC_po'])+' | no', timeout=300)
        ...
        VxLANCC = testscript.parameters['LEAF-1'].execute('show consistency-checker vxlan selective-qinvni interface '+str(testscript.parameters['intf_LEAF_1_to_IXIA'])+' | no', timeout=300)
        ...
        VxLANCC = testscript.parameters['LEAF-2'].execute('show consistency-checker vxlan selective-qinvni interface port-channel '+str(testscript.parameters['LEAF_2_dict']['VPC_data']['VPC_ACC_po'])+' | no', timeout=300)
        ...
        VxLANCC = testscript.parameters['LEAF-2'].execute('show consistency-checker vxlan selective-qinvni interface '+str(testscript.parameters['intf_LEAF_2_to_IXIA'])+' | no', timeout=300)
        ...
        VxLANCC = testscript.parameters['LEAF-3'].execute('show consistency-checker vxlan selective-qinvni interface '+str(testscript.parameters['intf_LEAF_3_to_IXIA'])+' | no', timeout=300)
...
class TC020_VxLAN_SQinVNI_Toggle_System_dot1q_Tunnel_Transit(aetest.Testcase):
    """ TC020_VxLAN_SQinVNI_Toggle_System_dot1q_Tunnel_Transit """

    @aetest.test
    def Toggle_System_dot1q_Tunnel_Transit(self, testscript):
        """ Toggle_System_dot1q_Tunnel_Transit """

        testscript.parameters['LEAF-1'].configure('''no system dot1q-tunnel transit vlan '''+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+''' ''')
        testscript.parameters['LEAF-2'].configure('''no system dot1q-tunnel transit vlan '''+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+''' ''')

        sleep(30)
        
        testscript.parameters['LEAF-1'].configure('''system dot1q-tunnel transit vlan '''+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+''' ''')
        testscript.parameters['LEAF-2'].configure('''system dot1q-tunnel transit vlan '''+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+''' ''')
...
class TC021_VxLAN_SQinVNI_ConfigReplace(aetest.Testcase):
    """ TC021_VxLAN_SQinVNI_ConfigReplace """
    ...
    def Config_Replace(self, testscript):
        ...
        testscript.parameters['LEAF-1'].configure('''
              ...
              no system dot1q-tunnel transit vlan '''+str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])+1)+'''
        ...
        testscript.parameters['LEAF-2'].configure('''
              ...
              no system dot1q-tunnel transit vlan '''+str(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+'''-'''+str(int(testscript.parameters['LEAF_2_dict']['VNI_data']['l2_vlan_start'])+1)+'''
...
class TC022_VxLAN_L2KUC_traffic_on_SQinVNI_Port(aetest.Testcase):
    """ TC022_VxLAN_L2KUC_traffic_on_SQinVNI_Port """
...
class TC023_VxLAN_L3KUC_traffic_on_SQinVNI_Port(aetest.Testcase):
    """ TC023_VxLAN_L3KUC_traffic_on_SQinVNI_Port """
...
class TC024_VxLAN_plus_SQinVNI_traffic_on_SQinVNI_Port(aetest.Testcase):
    """ TC024_VxLAN_plus_SQinVNI_traffic_on_SQinVNI_Port """
...
class TC025_iCAM_Check(aetest.Testcase):
    """ TC025_iCAM_Check """
...
class TC026_FINAL_CC_CHECK(aetest.Testcase):
    """ TC026_FINAL_CC_CHECK """
...
class TC027_Modify_TestBed_For_Ingress_Replication_Verification(aetest.Testcase):
    """ TC027_Modify_TestBed_For_Ingress_Replication_Verification """
    ...
    def configure_LEAF_1_2(self, testscript):
        ...
        testscript.parameters['LEAF-3'].configure('''
            ...
            interface nve 1
              ...
              no member vni ''' + str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vni_start']) + 3) + '''
              sleep 5
              member vni ''' + str(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vni_start']) + '''
                ingress-replication protocol bgp
              member vni ''' + str(int(testscript.parameters['LEAF_3_dict']['VNI_data']['l2_vni_start']) + 1) + '''
...
class TC028_VxLAN_SQinVNI_Verification(aetest.Testcase):
    """ TC028_VxLAN_SQinVNI_Verification """
...
class TC029_VxLAN_SQinVNI_UpLink_Flap(aetest.Testcase):
    """ TC029_VxLAN_SQinVNI_UpLink_Flap """
...
class TC030_VxLAN_SQinVNI_vPC_UpLink_Flap(aetest.Testcase):
    """ TC030_VxLAN_SQinVNI_vPC_UpLink_Flap """
...
class TC031_VxLAN_SQinVNI_Access_Link_Flap(aetest.Testcase):
    """ TC031_VxLAN_SQinVNI_Access_Link_Flap """
...
class TC032_VxLAN_SQinVNI_vPC_Access_LinkFlap(aetest.Testcase):
    """ TC032_VxLAN_SQinVNI_vPC_Access_LinkFlap """
...
class TC033_VxLAN_SQinVNI_NVE_Flap(aetest.Testcase):
    """ TC033_VxLAN_SQinVNI_NVE_Flap """
...
class TC034_VxLAN_SQinVNI_vPC_NVE_Flap(aetest.Testcase):
    """ TC034_VxLAN_SQinVNI_vPC_NVE_Flap """
...
class TC035_VxLAN_SQinVNI_Add_Remove_VN_Segemnt(aetest.Testcase):
    """ TC035_VxLAN_SQinVNI_Add_Remove_VN_Segemnt """
...
class TC036_VxLAN_SQinVNI_vPC_Remove_Add_VN_Segment(aetest.Testcase):
    """ TC036_VxLAN_SQinVNI_vPC_Remove_Add_VN_Segment """
...
class TC037_VxLAN_SQinVNI_SA_Remove_Add_Member_VN(aetest.Testcase):
    """ TC037_VxLAN_SQinVNI_SA_Remove_Add_Member_VN """
...
class TC038_VxLAN_SQinVNI_vPC_Remove_Add_Member_VNI(aetest.Testcase):
    """ TC038_VxLAN_SQinVNI_vPC_Remove_Add_Member_VNI """
...
class TC039_VxLAN_SQinVNI_SA_Loopback_Flap(aetest.Testcase):
    """ TC039_VxLAN_SQinVNI_SA_Loopback_Flap """
...
class TC040_VxLAN_SQinVNI_vPC_Loopback_Flap(aetest.Testcase):
    """ TC040_VxLAN_SQinVNI_vPC_Loopback_Flap """
...
class TC041_VxLAN_SQinVNI_SA_Remove_Add_VLAN(aetest.Testcase):
    """ TC041_VxLAN_SQinVNI_SA_Remove_Add_VLAN """
...
class TC042_VxLAN_SQinVNI_vPC_Remove_Add_VLAN(aetest.Testcase):
    """ TC042_VxLAN_SQinVNI_vPC_Remove_Add_VLAN """
...
class TC043_VxLAN_SQinVNI_Change_Access_VLAN_All_Nodes(aetest.Testcase):
    """ TC043_VxLAN_SQinVNI_Change_Access_VLAN_All_Nodes """
...
class TC044_VxLAN_SQinVNI_ConsistencyCheck(aetest.Testcase):
    """ TC044_VxLAN_SQinVNI_ConsistencyCheck """
...
class TC045_VxLAN_SQinVNI_Toggle_System_dot1q_Tunnel_Transit(aetest.Testcase):
    """ TC045_VxLAN_SQinVNI_Toggle_System_dot1q_Tunnel_Transit """
...
class TC046_VxLAN_SQinVNI_ConfigReplace(aetest.Testcase):
    """ TC046_VxLAN_SQinVNI_ConfigReplace """
...
class TC047_VxLAN_L2KUC_traffic_on_SQinVNI_Port(aetest.Testcase):
    """ TC047_VxLAN_L2KUC_traffic_on_SQinVNI_Port """
...
class TC048_VxLAN_L3KUC_traffic_on_SQinVNI_Port(aetest.Testcase):
    """ TC048_VxLAN_L3KUC_traffic_on_SQinVNI_Port """
...
class TC049_VxLAN_plus_SQinVNI_traffic_on_SQinVNI_Port(aetest.Testcase):
    """ TC049_VxLAN_plus_SQinVNI_traffic_on_SQinVNI_Port """
...
class TC050_iCAM_Check(aetest.Testcase):
    """ TC050_iCAM_Check """
...
class TC051_FINAL_CC_CHECK(aetest.Testcase):
    """ TC051_FINAL_CC_CHECK """
...
class common_cleanup(aetest.CommonCleanup):
    ...
    def CheckPoint_Before_Starting_Script_on_All_Nodes(self, testscript):
        ...
        log.info(banner("RollBack CleanUp While Ending the Script on All Nodes"))

        fail_flag = 0

        testscript.parameters['SPINE'].execute('''

            rollback running-config file bootflash:b4_script_run.cfg verbose 
        ...
        spine_rollback_status   = json.loads(testscript.parameters['SPINE'].execute('''show rollback status | json'''))
        leaf1_rollback_status   = json.loads(testscript.parameters['LEAF-1'].execute('''show rollback status | json'''))
        leaf2_rollback_status   = json.loads(testscript.parameters['LEAF-2'].execute('''show rollback status | json'''))
        leaf3_rollback_status   = json.loads(testscript.parameters['LEAF-3'].execute('''show rollback status | json'''))
        fan_rollback_status     = json.loads(testscript.parameters['FAN'].execute('''show rollback status | json'''))

        if spine_rollback_status['operation_status'] == 'Success':
            log.info("PASS: Rollback Passed on SPINE")
        else:
            log.debug("FAIL: Rollback Failed on SPINE")
            fail_flag = 1

        if leaf1_rollback_status['operation_status'] == 'Success':
            log.info("PASS: Rollback Passed on LEAF-1")
        else:
            log.debug("FAIL: Rollback Failed on LEAF-1")
            fail_flag = 1

        if leaf2_rollback_status['operation_status'] == 'Success':
            log.info("PASS: Rollback Passed on LEAF-2")
        else:
            log.debug("FAIL: Rollback Failed on LEAF-2")
            fail_flag = 1

        if leaf3_rollback_status['operation_status'] == 'Success':
            log.info("PASS: Rollback Passed on LEAF-3")
        else:
            log.debug("FAIL: Rollback Failed on LEAF-3")
            fail_flag = 1

        if fan_rollback_status['operation_status'] == 'Success':
            log.info("PASS: Rollback Passed on FAN")
        else:
            log.debug("FAIL: Rollback Failed on FAN")
            fail_flag = 1

        if fail_flag == 1:
            self.failed(reason="RollBack Failed on Few or All Nodes")
        else:
            self.passed(reason="RollBack Passed on All Nodes")
