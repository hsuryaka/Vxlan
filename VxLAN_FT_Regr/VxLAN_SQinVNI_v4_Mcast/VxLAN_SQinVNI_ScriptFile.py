...
class TC017_VxLAN_SQinVNI_ConsistencyCheck(aetest.Testcase):
    ...
    def VxLAN_CC(self, testscript):
        ...
        VxLANCC = testscript.parameters['LEAF-1'].execute('show consistency-checker vxlan selective-qinvni '+str(testscript.parameters['LEAF_1_dict']['VPC_data']['VPC_ACC_po'])+' | no')
        ...
        VxLANCC = testscript.parameters['LEAF-1'].execute('show consistency-checker vxlan selective-qinvni '+str(testscript.parameters['intf_LEAF_1_to_IXIA'])+' | no')
        ...
        VxLANCC = testscript.parameters['LEAF-2'].execute('show consistency-checker vxlan selective-qinvni '+str(testscript.parameters['LEAF_2_dict']['VPC_data']['VPC_ACC_po'])+' | no')
        ...
        VxLANCC = testscript.parameters['LEAF-2'].execute('show consistency-checker vxlan selective-qinvni '+str(testscript.parameters['intf_LEAF_2_to_IXIA'])+' | no')
        ...
        VxLANCC = testscript.parameters['LEAF-3'].execute('show consistency-checker vxlan selective-qinvni '+str(testscript.parameters['intf_LEAF_3_to_IXIA'])+' | no')
