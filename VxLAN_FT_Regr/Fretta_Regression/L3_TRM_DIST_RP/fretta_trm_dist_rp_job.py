...
def main():
    ...
    #test_path = '/ws/pkanduri-bgl/N9K_Scripts_Porting/L3_TRM_DIST_RP/'
    #test_path.pop()
    #test_path.append('scripts')
    #test_path.append('haggan_trm_dist_rp.py')
    #testscript = '/'.join(test_path)
    testscript = '/ws/hganapat-bgl/L3_TRM_DIST_RP/haggan_trm_dist_rp_new.py'
    # run api launches a testscript as an individual task.
    #run(testscript)
#    run(testscript, traffic_threshold = 10,tgn_connect = 1, uids = Or('common_setup','VXLAN-L3-TRM-FUNC-080','VXLAN-L3-TRM-FUNC-081','VXLAN-L3-TRM-FUNC-082'))
#    run(testscript, traffic_threshold = 10,tgn_connect = 1, uids = Or('common_setup','VXLAN-L3-TRM-FUNC-054'))
