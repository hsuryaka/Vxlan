...
# (pyats_jdGrp_vxlan_automation_base) bash-4.2$ easypy -jobfile /ws/jumashan-bgl/pyats_new/users/jumashan/vxlan_sundown/MyScripts/VxLAN_DCI_MCast/jobs/vxlan_dci_mcast_job.py --config-file /ws/jumashan-bgl/pyats_new/users/jumashan/vxlan_sundown/MyScripts/VxLAN_DCI_MCast/configs/vxlan_dci_mcast_config.yaml -testbed /ws/jumashan-bgl/pyats_new/users/jumashan/vxlan_sundown/MyScripts/VxLAN_DCI_MCast/testbed/VxLAN_DCI_MCast_Testbed.yaml

# EARMS RUN REPORT FOR KR2F CCO : https://earms-trade.cisco.com/tradeui/logs/details?archive=/auto/dc3-india/jdasgupt_grp/pyats_jdGrp_vxlan_automation_base/users/jumashan/archive/22-02/vxlan_dci_mcast_job.2022Feb11_17:21:21.319532.zip&atstype=ATS
# EARMS RUN REPORT FOR KR3F #72 CCO : https://earms-trade.cisco.com/tradeui/logs/details?archive=/auto/dc3-india/jdasgupt_grp/pyats_jdGrp_vxlan_automation_base/users/jumashan/archive/22-02/vxlan_dci_mcast_job.2022Feb14_16:30:11.651926.zip&atstype=ATS
...
def main():
    ...
    test_path.append('vxlan_dci_mcast.py')
    testscript = '/'.join(test_path)
    run(testscript, traffic_threshold = 2,tgn_connect = 1,\
        config_interface = 0,\
        config_ospf = 0,\
        config_bgp = 0,\
