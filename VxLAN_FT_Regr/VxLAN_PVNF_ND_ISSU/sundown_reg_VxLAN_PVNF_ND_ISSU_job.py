...
def main():
    ...
    if args.n_rel_abs_path == None or args.n_rel_upg_abs_apth == None or args.n_1_rel_abs_path == None:
        ...
        testscript          = './sundown_reg_VxLAN_PVNF_ND_ISSU_script.py'
        configurationFile   = './sundown_reg_VxLAN_PVNF_ND_ISSU_config.yaml'

        # Devices required for the test
        uut_devices = {
            'SPINE'                 : 'FX3-REG-TB2-TOR3',
            'LEAF-1'                : 'FX3-REG-TB2-TOR1',
            'LEAF-2'                : 'FX3-REG-TB2-TOR2',
            'LEAF-3'                : 'FX3-REG-TB1-TOR3',
            'BL'                    : 'FX3-REG-TB1-TOR2',
            'PGW'                   : 'FX3-REG-TB1-NODE7',
            'ixia'                  : 'IXIA',
            'lnx-server'            : 'bgl-golden-tftp'
        }
