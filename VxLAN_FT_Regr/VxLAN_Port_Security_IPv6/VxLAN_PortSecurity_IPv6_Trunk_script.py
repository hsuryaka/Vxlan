...
def verify_config_replace(device_list, log):
    ...
    return Flag
def basic_interface_configs(device_list, interface, vlan, mode='trunk'):
...
class DEVICE_BRINGUP(aetest.Testcase):
    ...
    @aetest.test
    def configure_trunk_vlan_port_security(self, testscript, testbed, steps):
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        sa_vtep         = testscript.parameters['LEAF-3']
...
########################################################################################################
class TC_VXLAN_PS_000_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        ...
        new_config = '''switchport port-security aging type inactivity
                        switchport port-security violation restrict
                        switchport port-security mac-address {mac} vlan {vlan}'''.format(mac=leaf1_mac, vlan=src_vlan)
    ...
    def verify_nd_issu_standalone(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after ISSU"):
            if VerifyTraffic("Test_SA_Trunk_ISSU", testscript, traffic_item='Trunk Orphan To Standalone'):
    ...
    def verify_nd_issu_primary(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_Primary_ISSU_Trunk", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after ISSU')
            else:
                self.failed('Verify Traffic Failed after ISSU')
    ...
    def verify_nd_issu_newprimary(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_New_Primary_ISSU_Trunk", testscript, 
                             traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after ISSU')
            else:
                self.failed('Verify Traffic Failed after ISSU')
    ...
    def test_cleanup(self, testscript, testbed, steps):
        ...
        new_config = '''no switchport port-security aging type inactivity
                      no switchport port-security violation restrict
                      no switchport port-security mac-address {mac} vlan {vlan}'''.format(mac=leaf1_mac, vlan=src_vlan)
...
# =============================================================================================================================#
class TC_VXLAN_PS_001_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def learn_mac_and_verify_peer_vtep(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_001_Orphan", testscript, traffic_item='Trunk Orphan To Standalone'):
...
# 3. Learn mac with vlan 1001 as dynamic and 1002
# =============================================================================================================================#
class TC_VXLAN_PS_002_Trunk(aetest.Testcase):
    @aetest.test
    def configure_trunk_vlan_port_security(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def learn_mac_and_verify_peer_vtep(self, testscript, testbed, steps):
        ...
        stream1 = ixNetwork.Traffic.TrafficItem.find(Name='Trunk FEX To Standalone')
        stream1.StartStatelessTraffic()
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_001_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
...
# 3. Learn mac with vlan 1001 as dynamic and 1002
# =============================================================================================================================#
class TC_VXLAN_PS_003_Trunk(aetest.Testcase):
    @aetest.test
    def verify_dynamic_mac_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            ...
            if VerifyTraffic("Test_004_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                self.passed('Verify traffic success')
            else:
                self.failed('Verify traffic failure')
...
#     address sticky
# =============================================================================================================================#
class TC_VXLAN_PS_004_Trunk(aetest.Testcase):
    @aetest.test
    def verify_sticky_static_mac_orphan(self, testscript, testbed, steps):
        ...
        with steps.start("Configure Port-Security - Static and Sticky on Standalone VTEP"):
            new_config = '''switchport port-security mac-address {mac} vlan {vlan}
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_004_Orphan", testscript, traffic_item='Trunk Orphan To Standalone'):
    ...
    def remove_portsecurity_check_macs(self, testscript, testbed, steps):
        ...
        with steps.start("UnConfigure Port-Security - Static and Sticky on Standalone VTEP"):
            new_config = '''no switchport port-security mac-address {mac} vlan {vlan}
...
# 4. Remove port-security and mac shoud be removed
# =============================================================================================================================#
class TC_VXLAN_PS_005_Trunk(aetest.Testcase):
    @aetest.test
    def verify_sticky_static_mac_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_005_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
...
# 4. Remove port-security and mac shoud be removed
# =============================================================================================================================#
class TC_VXLAN_PS_006_Trunk(aetest.Testcase):
    @aetest.test
    def verify_sticky_static_mac_fex(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_006_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
...
# =========================================================================================================#
class TC_VXLAN_PS_007_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_aging_absolute_orphan(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_007_Orphan", testscript, traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_aging_absolute_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_007_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_aging_absolute_fex(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_007_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
...
#  - Re-learn the macs through same port and verify the traffic
# ========================================================================================================#
class TC_VXLAN_PS_008_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_aging_inactive_orphan(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_008_Orphan", testscript, 
                             traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_aging_inactive_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_008_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_aging_inactive_fex(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_008_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
...
#  - Re-learn the macs through same port and verify the traffic
# =========================================================================================================#
class TC_VXLAN_PS_009_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_aging_inactive_violation_restrict_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTrafficDrop("Test_009_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_aging_inactive_violation_restrict_fex(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_009_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
...
#  - Re-learn the macs through same port and verify the traffic
# =========================================================================================================#
class TC_VXLAN_PS_010_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_aging_inactive_violation_protect_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTrafficDrop("Test_010_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_aging_inactive_violation_protect_fex(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_010_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
...
# ========================================================================================================#
class TC_VXLAN_PS_011_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
...
# =============================================================================================================================#
class TC_VXLAN_PS_012_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_violation_restrict_orphan(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTrafficDrop("Test_012_Orphan", testscript, traffic_item='Trunk Orphan To Standalone'):
                self.passed('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_violation_restrict_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTrafficDrop("Test_012_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                self.passed('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_violation_restrict_fex(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTrafficDrop("Test_012_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
                self.passed('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
...
#      - All traffic with the drop mac should be dropped
# =============================================================================================================================#
class TC_VXLAN_PS_013_Trunk(aetest.Testcase):
    @aetest.test
    ...
    def verify_violation_protect_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTrafficDrop("Test_013_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                self.passed('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_violation_restrict_fex(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            ...
            if VerifyTrafficDrop("Test_013_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
                self.passed('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
...
########################################################################################################
class TC_VXLAN_PS_014_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        ...
        with steps.start("Configure Port-Security on VPC Primary/Secondary - Static"):
            new_config = 'switchport port-security mac-address {mac} vlan {vlan}'.format(mac=leaf1_mac, vlan=src_vlan)
            if not config_interface_ps([prim_vtep, sec_vtep], 'port-channel 11', log, new_config):
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
    ...
    def verify_default_standalone_and_orphan_interface(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after trigger"):
            if VerifyTraffic("Test_016_Orphan", testscript, traffic_item='Trunk Orphan To Standalone'):
    ...
    def verify_default_portchannel(self, testscript, testbed, steps):
        ...
        with steps.start("Configure Port-Security on VPC Primary/Secondary - Static"):
            if not basic_interface_configs([prim_vtep, sec_vtep], 'port-channel 11', '1001'):
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
            new_config = '''switchport port-security mac-address {mac} vlan {vlan}
                           vpc 11'''.format(mac=leaf1_mac, vlan=src_vlan)
            if not config_interface_ps([prim_vtep, sec_vtep], 'port-channel 11', log, new_config):
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
        ...
        with steps.start("Verify Steady State after trigger"):
            if VerifyTraffic("Test_016_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after trigger')
            else:
                self.failed('Verify Traffic Failed after trigger')
    ...
    def verify_default_fex_interface(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after trigger"):
            if VerifyTraffic("Test_016_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
    ...
    def test_cleanup(self, testscript, testbed, steps):
        ...
        with steps.start("UnConfigure Port-Security on VPC Primary/Secondary - Static"):
            new_config = 'no switchport port-security mac-address {mac} vlan {vlan}'.format(mac=leaf1_mac, vlan=src_vlan)
            if not unconfig_interface_ps([prim_vtep, sec_vtep], 'port-channel 11', log, new_config):
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
...
########################################################################################################
class TC_VXLAN_PS_015_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_flap_standalone_and_orphan_interface(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after interface flap"):
            if VerifyTraffic("Test_017_Orphan", testscript, traffic_item='Trunk Orphan To Standalone'):
    ...
    def verify_portchannel_flap(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_017_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
    ...
    def verify_fex_interface_flap(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after fex interface flap"):
            if VerifyTraffic("Test_017_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
...
#   - shut/no shut orphan port interface, fex port interface, vpc interface and vpc port-channel
########################################################################################################
class TC_VXLAN_PS_016_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_access_port_flap_standalone_and_orphan_interface(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after interface flap"):
            if VerifyTraffic("Test_018_Orphan", testscript, traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success after flap')
            else:
                self.failed('Verify traffic failed after flap')
    ...
    def verify_portchannel_flap(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_018_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after interface flap')
            else:
                self.failed('Verify Traffic Failed after interface flap')
    ...
    def verify_fex_uplink_flap(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after fex interface flap"):
            if VerifyTraffic("Test_018_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
                log.info('Verify Traffic success after fex interface flap')
            else:
                log.debug('Verify Traffic failed after fex interface flap')
...
# NVE FLAP - Trunk Mode
########################################################################################################
class TC_VXLAN_PS_017_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        ...
        with steps.start("Configure Port-Security on Leaf1(Primary) - Static and Sticky on port-channel 11"):
            try:
                prim_vtep.configure('''interface port-channel 11
                                no switchport port-security
                                shutdown
                                switchport port-security mac-address {mac} vlan {vlan}
                                switchport port-security aging type inactivity
                                switchport port-security violation restrict
                                switchport port-security
                                no shutdown 
                            '''.format(mac=leaf1_mac, vlan=src_vlan))
            except Exception as error:
                log.debug("Unable to configure - Encountered Exception " + str(error))
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
        ...
        with steps.start("Configure Port-Security on Leaf2(Secondary) - Static and Sticky on port-channel 11"):
            try:
                sec_vtep.configure('''interface port-channel 11
                                ...
                                switchport port-security
                                no shutdown 
                            '''.format(mac=leaf2_mac, vlan=src_vlan))
            except Exception as error:
                log.debug("Unable to configure - Encountered Exception " + str(error))
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
    ...
    def verify_nve_flap_standalone_and_orphan_interface(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after nve flap"):
            if VerifyTraffic("Test_019_NVE_Flap", testscript, traffic_item='Trunk Orphan To Standalone'):
    ...
    def verify_portchannel_nve_flap(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after nve flap"):
            if VerifyTraffic("Test_019_NVE_Flap", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after nve flap')
            else:
                self.failed('Verify Traffic Failed after nve flap')
    ...
    def verify_fex_nve_flap(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after fex nve flap"):
            if VerifyTraffic("Test_019_FEX_NVE_Flap", testscript, traffic_item='Trunk FEX To Standalone'):
    ...
    def test_cleanup(self, testscript, testbed, steps):
        ...
        with steps.start("Remove Port-Security on Leaf-1 VPC Member"):
            try:
                prim_vtep.configure('''interface port-channel 11
                                no switchport port-security mac-address {mac} vlan {vlan}
                                no switchport port-security aging type inactivity
                                no switchport port-security violation restrict
                                no switchport port-security'''.format(mac=leaf1_mac, vlan=src_vlan))
            except Exception as error:
                log.debug("Unable to configure - Encountered Exception " + str(error))
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
        ...
        with steps.start("Remove Port-Security on Leaf-2 VPC Member"):
            try:
                sec_vtep.configure('''interface port-channel 11
                                ...
                                no switchport port-security aging type inactivity
                                no switchport port-security violation restrict
                                no switchport port-security'''.format(mac=leaf2_mac, vlan=src_vlan))
            except Exception as error:
                log.debug("Unable to configure - Encountered Exception " + str(error))
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
...
########################################################################################################
class TC_VXLAN_PS_018_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
...
########################################################################################################
class TC_VXLAN_PS_019_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
    ...
    def verify_nve_restart_standalone_and_orphan_interface(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after nve process restart"):
            if VerifyTraffic("Test_017_VPC_NVE_Restart", testscript, traffic_item='Trunk Orphan To Standalone'):
...
########################################################################################################
class TC_VXLAN_PS_020_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
    ...
    def verify_l2fm_restart_standalone_and_orphan_interface(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after l2fm restart"):
            if VerifyTraffic("Test_068_VPC_L2FM_Restart", testscript, traffic_item='Trunk Orphan To Standalone'):
    ...
    def verify_portchannel_l2fm_restart(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after l2fm restart on VPC Primary/Secondary"):
            if VerifyTraffic("Test_066_L2FM_Restart", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after L2FM Restart')
            else:
                self.failed('Verify Traffic Failed after L2FM Restart')
    ...
    def verify_fex_l2fm_restart(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after L2FM Restart"):
            if VerifyTraffic("Test_022_FEX_L2FM_Restart", testscript, traffic_item='Trunk FEX To Standalone'):
                log.info('Verify Traffic success after L2FM Restart')
            else:
...
########################################################################################################
class TC_VXLAN_PS_021_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
    ...
    def verify_fex_HMM_restart(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after HMM Restart"):
            if VerifyTraffic("Test_023_FEX_HMM_Restart", testscript, traffic_item='Trunk FEX To Standalone'):
                log.info('Verify Traffic success after HMM Restart')
            else:
...
# =============================================================================================================================#
class TC_VXLAN_PS_022_Trunk(aetest.Testcase):    
    @aetest.test
    def verify_mode_change_trunktoaccess_orphan(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        prim_vtep_if    = str(testscript.parameters['intf_LEAF_1_1_to_IXIA'])
        ...
        with steps.start("Change switchport mode to access - Standalone"):
            try:
                sa_vtep.configure('''interface {sa_vtep_if}
                                     switchport mode access   
                                  '''.format(sa_vtep_if=sa_vtep_if))
        ...
        with steps.start("Change switchport mode to access - Orphan"):
            try:
                prim_vtep.configure('''interface {intf}
                                       switchport mode access
...
# 4. Check traffic is fine
# =============================================================================================================================#
class TC_VXLAN_PS_023_Trunk(aetest.Testcase):
    @aetest.test
    def verify_mode_change_from_truntoaccess_vpc(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        sa_vtep_if      = str(testscript.parameters['intf_LEAF_3_to_IXIA'])
        ...
        with steps.start("Change switchport mode to access - PO11 Primary"):
            try:
                prim_vtep.configure('''interface port-channel 11
                                       switchport mode access''')
            except Exception as error:
        ...
        with steps.start("Change switchport mode to access - PO11 Secondary"):
            try:
                sec_vtep.configure('''interface port-channel 11
                                      switchport mode access''')
        ...
        with steps.start("Change mode back to trunk"):
            try:
                prim_vtep.configure('''interface port-channel 11
                                       switchport mode trunk''')
            except Exception as error:
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_025_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                self.passed('Verify traffic success')
            else:
                self.failed('Verify traffic failure')
...
# 4. Check traffic is fine
# =============================================================================================================================#
class TC_VXLAN_PS_024_Trunk(aetest.Testcase):    
    @aetest.test
    def verify_mode_change_trunk_to_access_fex(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        sec_vtep        = testscript.parameters['LEAF-2']
        ...
        with steps.start("Change switchport mode to trunk - FEX"):
            try:
                prim_vtep.configure('''interface {intf}
                                       switchport mode trunk
                                    '''.format(intf=prim_vtep_if))
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_026_FEX", testscript, traffic_item='Trunk FEX To Standalone'):
                self.passed('Verify traffic success')
            else:
                self.failed('Verify traffic failure')
...
# =============================================================================================================================#
class TC_VXLAN_PS_025_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
...
# =============================================================================================================================#
class TC_VXLAN_PS_026_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
...
# =================================================================================================#
class TC_VXLAN_PS_027_Trunk(aetest.Testcase):
    @aetest.test
...
#        Configuration should not be allowed
# ================================================================================================#
class TC_VXLAN_PS_028_Trunk(aetest.Testcase):
    @aetest.test
...
#        Configuration should not be allowed
# =============================================================================================================================#
class TC_VXLAN_PS_029_Trunk(aetest.Testcase):
    @aetest.test
...
# =============================================================================================================================#
class TC_VXLAN_PS_030_Trunk(aetest.Testcase):
    @aetest.test
...
# Static mac configuration with same vlan + interface with port-security not allowed
# =============================================================================================================================#
class TC_VXLAN_PS_031_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
        ...
        with steps.start("Configure Port-Security on Primary VTEP Orphan"):
            new_config = '''switchport trunk allowed vlan add 1002'''
            if not config_interface_ps([prim_vtep], prim_vtep_if, log, new_config):
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
    ...
    def verify_fex_port_security_with_remote_static(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTrafficDrop("Test_033_Fex", testscript, 
                                 traffic_item='Trunk FEX To Standalone'):
                log.info('Verify traffic success')
            else:
                self.failed('Verify traffic failed')
    ...
    def verify_errors_cores(self, testscript, testbed, steps):
        ...
        with steps.start("UnConfigure Port-Security on Primary VTEP Orphan"):
            new_config = '''switchport trunk allowed vlan remove 1002
                            switchport port-security maximum 1025'''
            if not unconfig_interface_ps([prim_vtep], prim_vtep_if, log, new_config):
                self.errored('Exception occurred while configuring port security', goto=['common_cleanup'])
...
# Use config-replace to replace the configuration after default interface
########################################################################################################
class TC_VXLAN_PS_032_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_orphan_remove_allowed_vlan(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after trigger"):
            if VerifyTraffic("Test_034_Trunk", testscript, traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success after trigger')
            else:
                self.failed('Verify traffic failed after trigger')
    ...
    def verify_portchannel_remove_allowed_vlan(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after trigger"):
            if VerifyTraffic("Test_034_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after trigger')
            else:
                self.failed('Verify Traffic Failed after trigger')
    ...
    def verify_fex_remove_allowed_vlan(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after trigger"):
            if VerifyTraffic("Test_034_FEX_Trunk", testscript, traffic_item='Trunk FEX To Standalone'):
                log.info('Verify Traffic success after trigger')
            else:
                self.failed('Verify Traffic failed after trigger')
...
# VPC port-channel and orphan, Standalone, Standalone + FEX ST
class TC_VXLAN_PS_033_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_reload_standalone(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after reload"):
            if VerifyTraffic("Test_011_Standalone", testscript, traffic_item='Trunk Orphan To Standalone'):
    ...
    def verify_reload_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            ...
            if VerifyTraffic("Test_014_VPC", testscript, traffic_item='Trunk VPC To Standalone'):
...
# TC-41 - ASCII Reload
class TC_VXLAN_PS_034_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep         = testscript.parameters['LEAF-3']
        prim_vtep       = testscript.parameters['LEAF-1']
    ...
    def verify_reload_standalone(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after reload"):
            if VerifyTraffic("Test_015_Orphan_Trunk", testscript, 
                             traffic_item='Trunk Orphan To Standalone'):
                log.info('Verify traffic success after reload')
            else:
                self.failed('Verify traffic failed after reload')
    ...
    def verify_vpc(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            ...
            if VerifyTraffic("Test_015_Trunk", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after Primary Reload')
            else:
                self.failed('Verify Traffic Success after Primary Reload')
    ...
    def test_cleanup(self, testscript, testbed, steps):
        ...
        new_config = '''no switchport port-security aging time 5
                        no switchport port-security aging type inactivity
                        no switchport port-security mac-address {mac} vlan {vlan}
                        no switchport port-security mac-address sticky'''.format(mac=leaf1_mac, vlan=src_vlan)
...
# VPC port-channel and orphan, Standalone, Standalone + FEX ST
########################################################################################################
class TC_VXLAN_PS_035_Trunk(aetest.Testcase):
    @aetest.test
    def test_setup(self, testscript, testbed, steps):
        sa_vtep = testscript.parameters['LEAF-3']
        prim_vtep = testscript.parameters['LEAF-1']
    ...
    def verify_issd_standalone(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State after ISSD"):
            if VerifyTraffic("Test_SA_Trunk_ISSD", testscript, traffic_item='Trunk Orphan To Standalone'):
    ...
    def verify_issd_primary(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_Primary_ISSD_Trunk", testscript, traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after ISSD')
            else:
                self.failed('Verify Traffic Failed after ISSD')
    ...
    def verify_issd_newprimary(self, testscript, testbed, steps):
        ...
        with steps.start("Verify Steady State"):
            if VerifyTraffic("Test_New_Primary_ISSD_Trunk", testscript, 
                             traffic_item='Trunk VPC To Standalone'):
                log.info('Verify Traffic Success after ISSD')
            else:
                self.failed('Verify Traffic Failed after ISSD')
    ...
    def test_cleanup(self, testscript, testbed, steps):
        ...
        stream1 = ixNetwork.Traffic.TrafficItem.find(Name='Trunk Orphan To Standalone')
        stream1.StopStatelessTraffic()
        stream2 = ixNetwork.Traffic.TrafficItem.find(Name='Trunk VPC To Standalone')
        stream2.StopStatelessTraffic()
        stream3 = ixNetwork.Traffic.TrafficItem.find(Name='Trunk FEX To Standalone')
