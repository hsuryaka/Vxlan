...
def main():
    ...
    testscript = os.path.join(test_path, '../vxlan_sundown/MyScripts/VxLAN_MS_DSVNI_ScriptFile.py')
    configurationFile = os.path.join(test_path, '../vxlan_sundown/MyScripts/VxLAN_MS_DSVNI_ConfigFile.yaml')
