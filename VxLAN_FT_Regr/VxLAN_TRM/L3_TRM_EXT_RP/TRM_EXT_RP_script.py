...
class VXLANL3TRMFUNC001(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPIntSrcIntRcv(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC002(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPIntSrcExtRcv(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC003(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMAExtRPIntSrcBL1Rcv(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC004(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPIntSrcBL2Rcv(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC005(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPIntSrcBL1BL2Rcv(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC006(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPIntSrcIntRxBL1Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC007(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPIntSrcIntRxBL2Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC008(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPIntSrcIntRxExtRx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC009(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPIntSrcExtRxBL1Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC011(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPIntSrcRxEverywhere(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC012(aetest.Testcase):
    ...
    uid = 'VXLAN-L3-TRM-FUNC-0123'

    @aetest.test
    def VxlanL3TRMExtRPIntSrcBL2RxIntEverywhere(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC013(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPBL1SrcRxEverywhere(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC014(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPBL2SrcRxEverywhere(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC015(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcIntRxBL1Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC016(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMAExtRPExtSrcIntRxBL2Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC017(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcIntRxBL1RxBL2Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC018(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcIntRx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC019(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcVPCRx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC020(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcBL1Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC021(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcBL2Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC022(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcBL1RxBL2Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC023(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcVPCPortRxBL1Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC024(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcVPCPortRxBL2Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC025(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPExtSrcVPCPortAndVPCOrphan(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC026(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPOIntExtSrcBL1Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC027(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPOIntExtSrcBL2Rx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC029(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPBLSrcExtSrcIntRx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC030(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtPBL2SrcExtSrcIntRx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
...
class VXLANL3TRMFUNC031(aetest.Testcase):
    ...
    @aetest.test
    def VxlanL3TRMExtRPBL2SrcExtSrcIntRx(self,log,testscript,testbed):
        tg_interface_hdl_dict = testscript.parameters['tg_interface_hdl_dict'] 
        traffic_stream_dict = testscript.parameters['traffic_stream_dict'] 
        port_handle_dict = testscript.parameters['port_handle_dict']
        TGList_config_file = testscript.parameters['TGList']
    ...
    def externalRPFlap(self,log,testscript,testbed):
        ...
        for TG in tgn_config_dict.keys():
            ...
            if out:
                ...
                flag = 0
                if not out:
                    log.error(banner('Traffic has not restored properly after the Trigger - External RP Flap'))
                    trigger_obj.backUpAndRestoreConfigs(list(device_dict.keys()),'restore')
                    flag = 1
