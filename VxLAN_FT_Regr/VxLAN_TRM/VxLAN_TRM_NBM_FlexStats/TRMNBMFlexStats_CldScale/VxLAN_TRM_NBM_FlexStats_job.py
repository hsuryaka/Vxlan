...
def main():
    ...
    # gRun(
    #     trigger_datafile=os.path.join(SCRIPT_PATH, "VxLAN_NBM_FlexStats_grun_data.yaml"),
    #     trigger_uids=[
    ...
    gRun(
        trigger_datafile=os.path.join(SCRIPT_PATH, "VxLAN_TRM_NBM_FlexStats_grun_data.yaml"),
        trigger_uids=[
