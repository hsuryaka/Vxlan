    ...
    def VERIFY_NIA_VxLAN_OUTER_DECAP_v4(self, testscript):
        ...
        niaCLIDecapOuter_v4 = {
            ...
            'element_params': {
                ...
                'last_path'     : [{'log_oif': str(testscript.parameters['LEAF_3_dict']['NVE_data']['src_loop']),
                                    'phy_oif': str(testscript.parameters['LEAF_3_dict']['NVE_data']['src_loop']), 
                                    'vlan':''}],
                'paths'         : [],
            }
        }
    ...
    def VERIFY_NIA_VxLAN_INNER_ENCAP_v4(self, testscript):
        ...
        niaCLIEncapInner_v4 = {
            ...
            'element_params': {
                ...
                'vlan'          : [str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vlan_start'])],
                'vni'           : [str(testscript.parameters['LEAF_1_dict']['VNI_data']['l2_vni_start'])],
                'vpc'           : ['port-channel'+str(testscript.parameters['LEAF_1_dict']['VPC_data']['peer_link_po']), 'port-channel'+str(testscript.parameters['LEAF_1_dict']['VPC_data']['VPC_ACC_po'])],
                'iif_vrf'       : str(testscript.parameters['forwardingSysDict']['VRF_string']) + '1',
                'route'         : [],
                'last_path'     : [],
                'paths'         : [{
    ...
    def VERIFY_NIA_VxLAN_OUTER_DECAP_v4(self, testscript):
        ...
        niaCLIDecapOuter_v4 = {
            ...
            'element_params': {
                ...
                'last_path'     : [{'log_oif': str(testscript.parameters['LEAF_1_dict']['NVE_data']['src_loop']),
                                    'phy_oif': str(testscript.parameters['LEAF_1_dict']['NVE_data']['src_loop']), 
                                    'vlan':''}],
                'paths'         : [],
            }
        }
