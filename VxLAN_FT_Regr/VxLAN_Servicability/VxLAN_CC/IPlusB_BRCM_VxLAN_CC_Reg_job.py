...
def main():
    ...
    testscript = os.path.join(test_path, '../vxlan_sundown/MyScripts/IPlusB_BRCM_VxLAN_CC_Reg.py')
    configurationFile = os.path.join(test_path, '../vxlan_sundown/MyScripts/IPlusB_BRCM_VxLAN_CC_Reg_config.yaml')
