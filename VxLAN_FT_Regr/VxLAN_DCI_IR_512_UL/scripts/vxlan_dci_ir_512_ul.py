...
class CommonSetup(aetest.CommonSetup):
    ...
    def Connect_To_Ixia(self,testscript,log):     
        ...
        if tgn_connect:
            ...
            # configFile = '/ws/jumashan-bgl/DCI_IR_512_400.ixncfg'
...
class TC032_vPC_BGW_Remove_Add_TRM_L2_VNI_IR(aetest.Testcase):
    """ TC032_vPC_BGW_Remove_Add_TRM_L2_VNI_IR """

    @aetest.test
    def vPC_BGW_Remove_Add_TRM_L2_VNI_IR(self,testscript,log,steps):
        """ vPC_BGW_Remove_Add_TRM_L2_VNI_IR """
        ...
        log.info(banner('Test:- Removing/Adding TRM L2 VNI IR on Both VPC BGWs...'))
        ...
        with steps.start('Remove TRM L2 VNI IR from the VPC BGWs')  as s:
            log.info(banner('Remove TRM L2 VNI IR from the VPC BGWs {0}'.format(list(vpc_dict.keys()))))
            for dut in vpc_dict:
                args = configdict['scale_config_dict'][dut]['interface']['nve']
                ns = MyLib.my_config_utils.parseNVEParams(log,args)
                for i in range(ns.no_of_l2_vni):
                    cfg = '''interface nve1
                                member vni {0}
                                no multisite ingress-replication'''.format(int(ns.l2_vni_start+i))
                    node_dict['all_dut'][dut].configure(cfg)
...
class TC033_vPC_BGW_Remove_Add_TRM_L3_VNI_IR(aetest.Testcase):
    """ TC033_vPC_BGW_Remove_Add_TRM_L3_VNI_IR """

    @aetest.test
    def vPC_BGW_Remove_Add_TRM_L3_VNI_IR(self,testscript,log,steps):
        """ vPC_BGW_Remove_Add_TRM_L3_VNI_IR """
        ...
        log.info(banner('Test:- Removing/Adding TRM L3 VNI IR on Both VPC BGWs...'))
        ...
        with steps.start('Remove TRM L3 VNI IR from the VPC BGWs')  as s:
            log.info(banner('Remove TRM L3 VNI IR from the VPC BGWs {0}'.format(list(vpc_dict.keys()))))
            for dut in vpc_dict:
                args = configdict['scale_config_dict'][dut]['interface']['nve']
                ns = MyLib.my_config_utils.parseNVEParams(log,args)
                for i in range(ns.no_of_l3_vni):
                    cfg = '''interface nve1
                                member vni {0} associate-vrf
                                no multisite ingress-replication optimized'''.format(int(ns.l3_vni_start+i))
                    node_dict['all_dut'][dut].configure(cfg)
...
class TC034_AC_BGW_Remove_Add_TRM_L2_VNI_IR(aetest.Testcase):
    """ TC034_AC_BGW_Remove_Add_TRM_L2_VNI_IR """

    @aetest.test
    def AC_BGW_Remove_Add_TRM_L2_VNI_IR(self,testscript,log,steps):
        """ AC_BGW_Remove_Add_TRM_L2_VNI_IR """
        ...
        log.info(banner('Test:- Removing/Adding TRM L2 VNI IR on Both AC BGWs...'))
        ...
        with steps.start('Remove TRM L2 VNI IR from the AC BGWs')  as s:
            log.info(banner('Remove TRM L2 VNI IR from the AC BGWs {0}'.format(list(ac_dict))))
            for dut in ac_dict:
                args = configdict['scale_config_dict'][dut]['interface']['nve']
                ns = MyLib.my_config_utils.parseNVEParams(log,args)
                for i in range(ns.no_of_l2_vni):
...
class TC035_AC_BGW_Remove_Add_TRM_L3_VNI_IR(aetest.Testcase):
    """ TC035_AC_BGW_Remove_Add_TRM_L3_VNI_IR """

    @aetest.test
    def AC_BGW_Remove_Add_TRM_L3_VNI_IR(self,testscript,log,steps):
        """ AC_BGW_Remove_Add_TRM_L3_VNI_IR """
        ...
        log.info(banner('Test:- Removing/Adding TRM L3 VNI IR on Both AC BGWs...'))
        ...
        with steps.start('Remove TRM L3 VNI IR from the AC BGWs')  as s:
            log.info(banner('Remove TRM L3 VNI IR from the AC BGWs {0}'.format(list(ac_dict))))
            for dut in ac_dict:
                args = configdict['scale_config_dict'][dut]['interface']['nve']
                ns = MyLib.my_config_utils.parseNVEParams(log,args)
                for i in range(ns.no_of_l3_vni):
...
class TC036_vPC_BGW_Process_Restart(aetest.Testcase):
    ...
    def vPC_BGW_Process_Restart(self,testscript,log):
        ...
        log.info(banner('Waiting for 600 seconds before measuring the Traffic Stats: '))
        countDownTimer(600)
...
class TC052_RemovingFeatureNGMVPNOnBGW(aetest.Testcase):
    ...
    def RemovingFeatureNGMVPNOnBGW(self,log,testscript,steps):
        ...
        log.info(banner('Waiting for 360 seconds before measuring the Traffic Stats: '))
        countDownTimer(360)
...
class TC057_ModifyNVESourceLoopbackIPOnVPCPrimary(aetest.Testcase):
    ...
    def ModifyNVESourceLoopbackIPOnVPCPrimary(self,log,testscript,steps):
        ...
        with steps.start('Checking Nve Peers ') as s:
            ...
            ixNetwork.StopAllProtocols()
            if Loss_per == '':
                if (int(txFrames)-int(rxFrames)) in range(0,1001):
