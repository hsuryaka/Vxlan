...
usg_msg = '''
pyats run job VxLAN_PVMAP_IPv4_IR_Job.py -t VxLAN_PVMAP_TB.yaml --n_rel_abs_path <abs_path_n_rel_img> --n_rel_base_img <abs_base_img>
Example:
pyats run job VxLAN_PVMAP_IPv4_IR_Job.py -t VxLAN_PVMAP_TB.yaml --n_rel_abs_path  'nxos64-cs.10.2.2.72.F.bin' --n_rel_base_img 'nxos64-cs.10.2.2.72.F.bin.upg'
'''
...
def main():
    ...
    # if args.n_rel_abs_path == None or args.n_rel_upg_abs_apth == None or args.n_1_rel_abs_path == None:
        ...
        testscript = '/ws/ratrajen-bgl/automation/repo_develop/nexus-test-automation/eor/regression/nxos/test/N39kRegression/test/functional/Vxlan/VxLAN_FT_Regr/VxLAN_PVMAP_IR_V4/VxLAN_PVMAP_IR_script.py'
        configurationFile = '/ws/ratrajen-bgl/automation/repo_develop/nexus-test-automation/eor/regression/nxos/test/N39kRegression/test/functional/Vxlan/VxLAN_FT_Regr/VxLAN_PVMAP_IR_V4/VxLAN_PVMAP_IR_config.yaml'
