...
#             alias_intf_mapping['all_intf'].update(dict(zip(alias,intf)))
    ...
    def verifyConfiguationsBeforeStartOfTest(self,testscript,log,steps):
        ...
        cfg_dict = testscript.parameters['configdict']
        ...
        ospf_interface_dict = getOspfInterfaceV4AndV6Dict(log,cfg_dict)
        
        log.info(banner('The value of res is : {0}'.format(ospf_interface_dict)))
        
        # with steps.start('Verify OSPFv2 Neighborship on all duts') as s:
        #     log.info('Verifying the OSPFv2 Neighborship on all duts ......')
        #     res = verifyOSPFv4Neighorship(log,ospf_interface_dict,node_dict)
        ...
        #     res = verifyBGPL2EVPNNeighbor(log,cfg_dict['bgp_config_dict'],node_dict)
        ...
        with steps.start('Verify L2 and L3 VNI Status on all VTEPS') as s:
            ...
            res = verifyVNIStatus(log,cfg_dict,vtep_dict)
        ...
        with steps.start('Verify Nve Peers in VTEPs') as s:
            ...
            res = verifyNVEStatus(log,cfg_dict,vtep_dict)
