...
class COMMON_SETUP(aetest.CommonSetup):
    ...
    def connecting_to_devices(self, testscript, testbed, uut_list, configurationFile, script_flags=None):
        ...
        BL      = testscript.parameters['BL']           = testbed.devices[uut_list['BL']]
    ...
    def get_interfaces(self, testscript):
        ...
        testscript.parameters['intf_SPINE_to_BL']       = SPINE.interfaces['SPINE_to_BL'].intf

        testscript.parameters['intf_LEAF_1_to_SPINE']   = LEAF_1.interfaces['LEAF-1_to_SPINE'].intf
        testscript.parameters['intf_LEAF_1_to_PGW_1']   = LEAF_1.interfaces['LEAF-1_to_PGW_1'].intf
        testscript.parameters['intf_LEAF_1_to_PGW_2']   = LEAF_1.interfaces['LEAF-1_to_PGW_2'].intf
        ...
        testscript.parameters['intf_LEAF_2_to_PGW_1']   = LEAF_2.interfaces['LEAF-2_to_PGW_1'].intf
        testscript.parameters['intf_LEAF_2_to_PGW_2']   = LEAF_2.interfaces['LEAF-2_to_PGW_2'].intf

        testscript.parameters['intf_LEAF_3_to_SPINE']   = LEAF_3.interfaces['LEAF-3_to_SPINE'].intf
        testscript.parameters['intf_LEAF_3_to_PGW_1']   = LEAF_3.interfaces['LEAF-3_to_PGW_1'].intf
        testscript.parameters['intf_LEAF_3_to_PGW_2']   = LEAF_3.interfaces['LEAF-3_to_PGW_2'].intf

        testscript.parameters['intf_PGW_to_LEAF_1_1']   = PGW.interfaces['PGW_to_LEAF-1_1'].intf
        testscript.parameters['intf_PGW_to_LEAF_1_2']   = PGW.interfaces['PGW_to_LEAF-1_2'].intf
        testscript.parameters['intf_PGW_to_LEAF_2_1']   = PGW.interfaces['PGW_to_LEAF-2_1'].intf
        testscript.parameters['intf_PGW_to_LEAF_2_2']   = PGW.interfaces['PGW_to_LEAF-2_2'].intf
        testscript.parameters['intf_PGW_to_LEAF_3_1']   = PGW.interfaces['PGW_to_LEAF-3_1'].intf
        testscript.parameters['intf_PGW_to_LEAF_3_2']   = PGW.interfaces['PGW_to_LEAF-3_2'].intf
        testscript.parameters['intf_PGW_to_IXIA']       = PGW.interfaces['PGW_to_IXIA'].intf

        testscript.parameters['intf_BL_to_SPINE']       = BL.interfaces['BL_to_SPINE'].intf
        testscript.parameters['intf_BL_to_IXIA']        = BL.interfaces['BL_to_IXIA'].intf

        testscript.parameters['intf_IXIA_to_BL']        = IXIA.interfaces['IXIA_to_BL'].intf
...
class BASE_EVPN_VxLAN_BRINGUP(aetest.Testcase):
    ...
    def configure_BL(self, testscript):
        """ Device Bring-up subsection: Configuring BL """
    ...
    def configure_STOP_External_route_maps(self, testscript):
        ...
        LEAF_2.configure('''
                ...
                router bgp ''' + str(testscript.parameters['topo_1_vnf_leaves_dict'][LEAF_2]['leaf_as']) + '''
                    neighbor ''' + str(testscript.parameters['LEAF_2_dict']['SPINE_1_UPLINK_PO']['spine_leaf_po_v4']) + '''
                        address-family l2vpn evpn
                          send-community
                          send-community extended
        ...
        LEAF_3.configure('''
                ...
                router bgp ''' + str(testscript.parameters['topo_1_vnf_leaves_dict'][LEAF_3]['leaf_as']) + '''
                    neighbor ''' + str(testscript.parameters['LEAF_3_dict']['SPINE_1_UPLINK_PO']['spine_leaf_po_v4']) + '''
                        address-family l2vpn evpn
                          send-community
                          send-community extended
                          route-map ''' + str(LEAF_stop_rtmap_name) + ''' in
...
# *****************************************************************************************************************************#
class VERIFY_SINGLE_AND_DUAL_HOMED_PGW_LEAF_PATH_FLAP(aetest.Testcase):
...
# *****************************************************************************************************************************#
class VERIFY_RESTART_BGP_PROCESS(aetest.Testcase):
...
# *****************************************************************************************************************************#
class VERIFY_RESTART_NVE_PROCESS(aetest.Testcase):
...
# *****************************************************************************************************************************#
class VERIFY_PVNF_BL_RELOAD(aetest.Testcase):
    """VERIFY_PVNF_BL_RELOAD"""

    # =============================================================================================================================#
    @aetest.test
    def PVNF_BL_RELOAD(self, testscript):
        """ IXIA_CONFIGURATION subsection: Verify IXIA Traffic """

        BL = testscript.parameters['BL']

        BL.configure("copy r s")

        # Perform Device Reload
        result = infraTrig.switchASCIIreload(BL)
        if result:
            log.info("ASCII Reload completed Successfully")
        else:
            log.debug("ASCII Reload Failed")
