...
class TC0001_VXLAN_XC_TGN_CONNECT(aetest.Testcase):
    ...
    def configureTgn(self, testscript, testbed):
        ...
        #port_handle = ConnectSpirent(labserver_ip,tgn_ip,tgn1_intf_list)
        ...
        try:            
            ...
            log.error("TGN Port Setup failed ")
            self.failed(goto=['common_cleanup'])        
...
class TC0004_VXLAN_Traffic_All_with_xconnect(aetest.Testcase):
    ...
    def setup(self):   
        ...
        test1= FloodTrafficGeneratorScale(port_handle_sw1,nonxc_vlan_start,ip_sa1,'100.100.100.100',nonxc_rate,str(nonxc_scale))
        test2= FloodTrafficGeneratorScale(port_handle_sw3,nonxc_vlan_start,ip_sa2,'200.200.200.200',nonxc_rate,str(nonxc_scale))
  
        log.info(banner("----Generating hosts Unicast Bidir Traffic----")) 

        SpirentBidirStream222(port_hdl1=port_handle_sw1,port_hdl2=port_handle_sw3,vlan1=nonxc_vlan_start,vlan2=nonxc_vlan_start,\
        ...
        SpirentV6BidirStream(port_handle_sw1,port_handle_sw3,nonxc_vlan_start,nonxc_vlan_start,nonxc_scale,\
    ...
    def vxlan_traffic_test_all(self):      
        ...
        if not AllTrafficTest(port_handle_sw1,port_handle_sw3,nonxc_rate,2500,orphan_handle_list):
            log.info("Failed AllTrafficTest @ 1")
    ...
    def cleanup(self):
        """ testcase clean up """  
        for port in [port_handle_sw1,port_handle_sw3]:
            streamblock_ret1 = sth.traffic_config(mode = 'reset',port_handle = port)  
