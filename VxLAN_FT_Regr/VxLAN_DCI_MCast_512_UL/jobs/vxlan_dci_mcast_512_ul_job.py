...
# (pyats_jdGrp_vxlan_automation_base) bash-4.2$ easypy -jobfile /ws/jumashan-bgl/pyats_new/users/jumashan/vxlan_sundown/MyScripts/VxLAN_DCI_MCast_512_UL/jobs/vxlan_dci_mcast_512_ul_job.py --config-file /ws/jumashan-bgl/pyats_new/users/jumashan/vxlan_sundown/MyScripts/VxLAN_DCI_MCast_512_UL/configs/vxlan_dci_mcast_512_ul_config.yaml -testbed /ws/jumashan-bgl/pyats_new/users/jumashan/vxlan_sundown/MyScripts/VxLAN_DCI_MCast_512_UL/testbed/VxLAN_DCI_MCast_512_UL_Testbed.yaml

# EARMS RUN REPORT FOR KR2F CCO : 
# EARMS RUN REPORT FOR KR3F #72 CCO : https://earms-trade.cisco.com/tradeui/logs/details?archive=/auto/dc3-india/jdasgupt_grp/pyats_jdGrp_vxlan_automation_base/users/jumashan/archive/22-02/vxlan_dci_mcast_512_ul_job.2022Feb15_17:31:36.445135.zip&atstype=ATS
# EARMS RUN REPORT FOR KR3F #72 CCO Failed Cases - 1 : https://earms-trade.cisco.com/tradeui/logs/details?archive=/auto/dc3-india/jdasgupt_grp/pyats_jdGrp_vxlan_automation_base/users/jumashan/archive/22-02/vxlan_dci_mcast_512_ul_job.2022Feb16_10:06:18.309226.zip&atstype=ATS
...
def main():
    ...
    test_path.append('vxlan_dci_mcast_512_ul.py')
    testscript = '/'.join(test_path)
    run(testscript, traffic_threshold = 5,tgn_connect = 1,\
        config_interface = 1,\
        config_ospf = 1,\
        config_bgp = 1,\
