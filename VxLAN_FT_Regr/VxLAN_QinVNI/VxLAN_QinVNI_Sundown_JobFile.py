...
def main():
    ...
    testscript = '/ws/pkanduri-bgl/N9K_Scripts_Porting/Q-in-VNI/VxLAN_QinVNI_ScriptFile.py'
    configurationFile = '/ws/pkanduri-bgl/N9K_Scripts_Porting/Q-in-VNI/VxLAN_QinVNI_ConfigFile.yaml'
